...
| `@croco/analytics-drizzle`       | Plugins / provider | Analytics       | Transactional PostgreSQL fact history store | yes  | yes    | -       | -        | PostgreSQL connection supplied by app                                               | drizzle-orm    | source receipt and projected row identity<br>atomic multi-projection append<br>effective and known time reads<br>revision compare-and-set<br>subject deletion tombstones                                                      | 🔴 alpha/WIP | has package tests | not-applicable<br>not required until production-ready or compatibility claim                       |
...
| `@croco/ai-usage`           | Domain      | `packages/ai-usage`           | README, API, tests |
...
| `@croco/analytics-drizzle`         | Provider     | `packages/analytics-drizzle`         | README, API, tests |
