...
| --- | ---: | ---: | ---: | ---: | --- | --- |
| `@croco/framework-context` | 89.42 | 78.20 | 95.60 | 89.34 | 없음 | 없음 |
| `@croco/problems-core` | 85.87 | 78.96 | 92.70 | 85.74 | 없음 | statements 85.87% < baseline 86.91%; lines 85.74% < baseline 86.77% |
| `@croco/protocols-core` | 86.07 | 74.53 | 91.76 | 86.44 | 없음 | functions 91.76% < baseline 92.61% |
| `@croco/protocols-rest` | 87.33 | 80.81 | 88.54 | 87.64 | 없음 | 없음 |
| `@croco/openapi-spec` | 91.50 | 81.96 | 92.77 | 91.16 | 없음 | statements 91.50% < baseline 91.82%; functions 92.77% < baseline 93.00%; lines 91.16% < baseline 91.55% |
| `@croco/rpc-codegen` | 91.14 | 81.10 | 96.90 | 91.06 | 없음 | 없음 |
| `@croco/transports-http` | 93.37 | 83.98 | 91.35 | 93.58 | 없음 | 없음 |
| `@croco/telemetry-api` | 92.54 | 91.00 | 97.29 | 92.94 | 없음 | 없음 |
...
| `@croco/tx-drizzle` | 85.90 | 76.98 | 91.76 | 85.90 | 없음 | statements 85.90% < baseline 96.90%; branches 76.98% < baseline 87.50%; functions 91.76% < baseline 96.96%; lines 85.90% < baseline 96.84% |
| `@croco/events-core` | 91.70 | 80.66 | 99.03 | 91.60 | 없음 | 없음 |
| `@croco/events-tx` | 92.54 | 85.11 | 91.00 | 92.96 | 없음 | 없음 |
| `@croco/retry-core` | 84.06 | 79.83 | 79.76 | 84.32 | 없음 | 없음 |
| `@croco/idempotency-core` | 85.65 | 79.56 | 96.84 | 85.91 | 없음 | statements 85.65% < baseline 89.81%; lines 85.91% < baseline 89.90% |
| `@croco/testing` | 84.40 | 76.60 | 87.09 | 84.66 | 없음 | 없음 |
| `create-croco-app` | 82.69 | 75.01 | 92.51 | 84.28 | 없음 | statements 82.69% < baseline 86.19%; branches 75.01% < baseline 78.36%; functions 92.51% < baseline 96.03%; lines 84.28% < baseline 89.60% |
| `@croco/cli` | 84.16 | 75.62 | 85.84 | 85.00 | 없음 | 없음 |
| `@croco/auth-core` | 93.77 | 90.37 | 96.20 | 93.84 | 없음 | statements 93.77% < baseline 94.09%; lines 93.84% < baseline 94.20% |
...
- @croco/protocols-core: functions 91.76% < baseline 92.61%
- @croco/openapi-spec: statements 91.50% < baseline 91.82%
- @croco/openapi-spec: functions 92.77% < baseline 93.00%
- @croco/openapi-spec: lines 91.16% < baseline 91.55%
...
- @croco/tx-drizzle: statements 85.90% < baseline 96.90%
- @croco/tx-drizzle: branches 76.98% < baseline 87.50%
- @croco/tx-drizzle: functions 91.76% < baseline 96.96%
- @croco/tx-drizzle: lines 85.90% < baseline 96.84%
- @croco/idempotency-core: statements 85.65% < baseline 89.81%
- @croco/idempotency-core: lines 85.91% < baseline 89.90%
- create-croco-app: statements 82.69% < baseline 86.19%
- create-croco-app: branches 75.01% < baseline 78.36%
- create-croco-app: functions 92.51% < baseline 96.03%
- create-croco-app: lines 84.28% < baseline 89.60%
- @croco/auth-core: statements 93.77% < baseline 94.09%
- @croco/auth-core: lines 93.84% < baseline 94.20%
