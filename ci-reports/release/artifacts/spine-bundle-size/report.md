...
- Generated at: 2026-09-15T15:50:25.116Z
...
| `package-manifests:check` | package manifests and Croco compatibility train | blocking through `pnpm check` | pass | 18 spine package(s); 155 generated app dependency row(s); 0 generated app range drift(s); 0 peer exception(s); run `pnpm package-manifests:check && pnpm package-quality:report` |
...
| `provider-certification:check` | provider, integration, transport, host, and presentation certification evidence | blocking on PR/trunk | success | validates catalog certification records and writes `ci-reports/package-quality/provider-certification.md` plus JSON |
...
| `@croco/framework-module` | non-spine | `workspace:*` | `^0.0.4` | `^0.0.4` | pass | `packages/create-croco-app/templates/addons/web-meta-vite-fullstack/api-worker/package.json.hbs` |
| `@croco/framework-module` | non-spine | `workspace:*` | `^0.0.4` | `^0.0.4` | pass | `packages/create-croco-app/templates/admin-console/apps/api-server/package.json.hbs` |
...
| `@croco/framework-module` | non-spine | `workspace:*` | `^0.0.4` | `^0.0.4` | pass | `packages/create-croco-app/templates/spa-be-split/apps/api-server/package.json.hbs` |
...
| `@croco/preset-cloudflare` | non-spine | `workspace:*` | `^0.0.4` | `^0.0.4` | pass | `packages/create-croco-app/templates/addons/web-meta-vite-fullstack/api-worker/package.json.hbs` |
| `@croco/preset-lambda` | non-spine | `workspace:*` | `^0.0.4` | `^0.0.4` | pass | `packages/create-croco-app/templates/admin-console/apps/api-server/package.json.hbs` |
| `@croco/preset-lambda` | non-spine | `workspace:*` | `^0.0.4` | `^0.0.4` | pass | `packages/create-croco-app/templates/spa-be-split/apps/api-server/package.json.hbs` |
| `@croco/preset-node` | non-spine | `workspace:*` | `^0.0.4` | `^0.0.4` | pass | `packages/create-croco-app/templates/admin-console/apps/api-server/package.json.hbs` |
| `@croco/preset-node` | non-spine | `workspace:*` | `^0.0.4` | `^0.0.4` | pass | `packages/create-croco-app/templates/spa-be-split/apps/api-server/package.json.hbs` |
...
| `@croco/transports-cloudflare-workers` | non-spine | `version-set` | `^0.0.4` | `^0.0.4` | pass | `packages/create-croco-app/src/helpers/croco-ranges.ts` |
...
## Bundle size warning
- Status: warning-only; 367 artifact(s) over baseline, 72 missing bundle-size baseline(s), 3 unmatched bundle-size baseline(s)
...
| `@croco/preset-cloudflare` | not-run | pass | not-run |  |
