...
export type ContractMethodDecorator<Expected> = <Target extends object, Key extends PropertyKey>(
  target: Target & Record<Key, AnyMethod> & (IsStaticTarget<Target> extends true ? never : unknown),
  propertyKey: Key,
...
export declare function route<Expected>(
  contract: PrototypeContract<Expected>,
): ContractMethodDecorator<Expected>;

export declare function parameter<Expected>(
  contract: PrototypeContract<Expected>,
): ContractParameterDecorator<Expected>;
