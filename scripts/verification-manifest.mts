...
export const VERIFICATION_LANE_OWNERSHIP = {
  ...
  "cli-packed-e2e": "package-artifacts",
...
export const VERIFICATION_DEPENDENCY_CLASSIFICATION = {
  ...
  "package-entrypoints-smoke->test": ["physical-local", "logical-synthesis"],
  ...
  "cli-packed-e2e->integration-test-lane": ["physical-local", "logical-synthesis"],
