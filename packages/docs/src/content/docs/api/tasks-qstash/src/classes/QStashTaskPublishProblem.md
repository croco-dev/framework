...
next: false
prev: false
title: "QStashTaskPublishProblem"
---
...
> **new QStashTaskPublishProblem**(`error`): `QStashTaskPublishProblem`
...
> `readonly` **code**: `"tasks-qstash/publish-failed"` = `"tasks-qstash/publish-failed"`
