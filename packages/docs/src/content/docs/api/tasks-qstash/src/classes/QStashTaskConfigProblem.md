...
> **new QStashTaskConfigProblem**(`configKey`): `QStashTaskConfigProblem`
...
> `readonly` **code**: `"tasks-qstash/missing-config"` = `"tasks-qstash/missing-config"`
