...
next: false
prev: false
title: "QStashTaskValidationProblem"
---
...
> **new QStashTaskValidationProblem**(`message`): `QStashTaskValidationProblem`
...
> `readonly` **code**: `"tasks-qstash/invalid-publish-request"` = `"tasks-qstash/invalid-publish-request"`
