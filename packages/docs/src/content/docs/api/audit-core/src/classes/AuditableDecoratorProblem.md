...
next: false
prev: false
title: "AuditableDecoratorProblem"
---
...
> **new AuditableDecoratorProblem**(`detail`): `AuditableDecoratorProblem`
...
> `readonly` **code**: `"audit-core/auditable-decorator-misuse"` = `"audit-core/auditable-decorator-misuse"`
