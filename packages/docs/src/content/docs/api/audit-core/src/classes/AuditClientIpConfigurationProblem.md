...
next: false
prev: false
title: "AuditClientIpConfigurationProblem"
---
...
> **new AuditClientIpConfigurationProblem**(`detail`): `AuditClientIpConfigurationProblem`
...
> `readonly` **code**: `"audit-core/client-ip-policy-invalid"` = `"audit-core/client-ip-policy-invalid"`
