...
next: false
prev: false
title: "BatchLoadUnkeyedResultProblem"
---
...
> **new BatchLoadUnkeyedResultProblem**(`index`): `BatchLoadUnkeyedResultProblem`
...
> `readonly` **code**: `"repository-core/batch-load-result-unkeyed"` = `"repository-core/batch-load-result-unkeyed"`
