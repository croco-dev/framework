...
next: false
prev: false
title: "BatchLoaderFactoryNotRegisteredProblem"
---
...
> **new BatchLoaderFactoryNotRegisteredProblem**(): `BatchLoaderFactoryNotRegisteredProblem`
...
> `readonly` **code**: `"repository-core/batch-loader-factory-not-registered"` = `"repository-core/batch-loader-factory-not-registered"`
