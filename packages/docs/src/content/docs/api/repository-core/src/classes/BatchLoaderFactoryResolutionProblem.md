...
next: false
prev: false
title: "BatchLoaderFactoryResolutionProblem"
---
...
> **new BatchLoaderFactoryResolutionProblem**(`message`): `BatchLoaderFactoryResolutionProblem`
...
> `readonly` **code**: `"repository-core/batch-loader-factory-resolution-failed"` = `"repository-core/batch-loader-factory-resolution-failed"`
