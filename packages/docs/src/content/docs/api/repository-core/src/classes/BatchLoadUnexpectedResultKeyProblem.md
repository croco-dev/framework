...
next: false
prev: false
title: "BatchLoadUnexpectedResultKeyProblem"
---
...
> **new BatchLoadUnexpectedResultKeyProblem**(): `BatchLoadUnexpectedResultKeyProblem`
...
> `readonly` **code**: `"repository-core/batch-load-result-key-unexpected"` = `"repository-core/batch-load-result-key-unexpected"`
