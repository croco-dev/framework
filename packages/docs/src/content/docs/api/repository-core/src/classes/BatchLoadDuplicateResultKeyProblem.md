...
next: false
prev: false
title: "BatchLoadDuplicateResultKeyProblem"
---
...
> **new BatchLoadDuplicateResultKeyProblem**(): `BatchLoadDuplicateResultKeyProblem`
...
> `readonly` **code**: `"repository-core/batch-load-result-key-duplicate"` = `"repository-core/batch-load-result-key-duplicate"`
