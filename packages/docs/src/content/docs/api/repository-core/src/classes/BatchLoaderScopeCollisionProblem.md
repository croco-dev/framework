...
> **new BatchLoaderScopeCollisionProblem**(`name`): `BatchLoaderScopeCollisionProblem`
...
> `readonly` **code**: `"repository-core/batch-loader-scope-collision"` = `"repository-core/batch-loader-scope-collision"`
