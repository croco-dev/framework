...
next: false
prev: false
title: "ResponseValidationProblem"
---
...
> **new ResponseValidationProblem**(`issues`): `ResponseValidationProblem`
...
> `readonly` **code**: `"protocols-rest/response-validation-failed"` = `"protocols-rest/response-validation-failed"`
