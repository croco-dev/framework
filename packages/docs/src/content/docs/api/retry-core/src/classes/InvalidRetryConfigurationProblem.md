...
next: false
prev: false
title: "InvalidRetryConfigurationProblem"
---
...
> **new InvalidRetryConfigurationProblem**(`option`, `constraint`, `received`): `InvalidRetryConfigurationProblem`
...
[`RetryNumericConstraint`](/api/retry-core/src/type-aliases/retrynumericconstraint/)
...
> `readonly` **code**: `"INVALID_RETRY_CONFIGURATION"` = `"INVALID_RETRY_CONFIGURATION"`
