...
> **new RedisCircuitBreakerStore**(`options`): `RedisCircuitBreakerStore`

#### Parameters

##### options

[`RedisCircuitBreakerStoreOptions`](/api/retry-core/src/type-aliases/rediscircuitbreakerstoreoptions/)
