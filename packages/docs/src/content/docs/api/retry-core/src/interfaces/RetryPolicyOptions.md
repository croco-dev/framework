...
Defined in: [packages/retry-core/src/libs/RetryPolicy.ts:20](https://github.com/croco-dev/framework/blob/dfdc13c04d1ec41944df1d6a5c5701779b83d710/packages/retry-core/src/libs/RetryPolicy.ts#L20)
