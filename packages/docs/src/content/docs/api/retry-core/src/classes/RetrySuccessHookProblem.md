...
> **new RetrySuccessHookProblem**(`methodName`, `attempt`, `cause`): `RetrySuccessHookProblem`
...
> `readonly` **code**: `"retry-core/success-hook-failed"` = `"retry-core/success-hook-failed"`
