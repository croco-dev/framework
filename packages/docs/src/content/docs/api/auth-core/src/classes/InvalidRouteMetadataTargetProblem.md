...
next: false
prev: false
title: "InvalidRouteMetadataTargetProblem"
---
...
> **new InvalidRouteMetadataTargetProblem**(`target`): `InvalidRouteMetadataTargetProblem`
...
> `readonly` **code**: `"auth-core/invalid-route-metadata-target"` = `"auth-core/invalid-route-metadata-target"`
