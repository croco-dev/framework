...
next: false
prev: false
title: "InvalidApiKeyRotationIdempotencyKeyProblem"
---
...
> **new InvalidApiKeyRotationIdempotencyKeyProblem**(): `InvalidApiKeyRotationIdempotencyKeyProblem`
...
> `readonly` **code**: `"auth-core/invalid-api-key-rotation-idempotency-key"` = `"auth-core/invalid-api-key-rotation-idempotency-key"`
