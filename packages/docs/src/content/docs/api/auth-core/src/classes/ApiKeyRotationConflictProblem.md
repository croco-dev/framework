...
next: false
prev: false
title: "ApiKeyRotationConflictProblem"
---
...
> **new ApiKeyRotationConflictProblem**(`detail?`): `ApiKeyRotationConflictProblem`

#### Parameters

##### detail?

`string` = `"API key rotation conflicts with an existing rotation"`
...
> `readonly` **code**: `"auth-core/api-key-rotation-conflict"` = `"auth-core/api-key-rotation-conflict"`
