...
next: false
prev: false
title: "InvalidHealthCheckTimeoutProblem"
---
...
> **new InvalidHealthCheckTimeoutProblem**(`source`, `timeoutMs`): `InvalidHealthCheckTimeoutProblem`

#### Parameters

##### source

[`HealthCheckTimeoutSource`](/api/health-core/src/type-aliases/healthchecktimeoutsource/)
...
> `readonly` **code**: `"health-core/invalid-timeout"` = `"health-core/invalid-timeout"`
