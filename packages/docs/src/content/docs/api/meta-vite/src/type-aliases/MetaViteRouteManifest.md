...
next: false
prev: false
title: "MetaViteRouteManifest"
---

> **MetaViteRouteManifest** = `object`
...
> `readonly` **serverActions**: readonly [`MetaViteServerActionManifestEntry`](/api/meta-vite/src/type-aliases/metaviteserveractionmanifestentry/)[]
