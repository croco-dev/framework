...
next: false
prev: false
title: "ServerActionNotFoundProblem"
---
...
> **new ServerActionNotFoundProblem**(`actionName`): `ServerActionNotFoundProblem`
...
> `readonly` **code**: `"meta-vite/server-action-not-found"` = `"meta-vite/server-action-not-found"`
