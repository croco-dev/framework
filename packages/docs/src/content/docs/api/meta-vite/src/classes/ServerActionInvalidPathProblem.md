...
next: false
prev: false
title: "ServerActionInvalidPathProblem"
---
...
> **new ServerActionInvalidPathProblem**(`path`): `ServerActionInvalidPathProblem`
...
> `readonly` **code**: `"meta-vite/server-action-invalid-path"` = `"meta-vite/server-action-invalid-path"`
