...
next: false
prev: false
title: "InvalidRateLimitPolicyProblem"
---
...
> **new InvalidRateLimitPolicyProblem**(`storeType`): `InvalidRateLimitPolicyProblem`
...
> `readonly` **code**: `"ratelimit-upstash/invalid-policy"` = `"ratelimit-upstash/invalid-policy"`
