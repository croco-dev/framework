...
next: false
prev: false
title: "MissingUpstashRateLimitConfigProblem"
---
...
> **new MissingUpstashRateLimitConfigProblem**(`configKey`): `MissingUpstashRateLimitConfigProblem`
...
> `readonly` **code**: `"ratelimit-upstash/missing-config"` = `"ratelimit-upstash/missing-config"`
