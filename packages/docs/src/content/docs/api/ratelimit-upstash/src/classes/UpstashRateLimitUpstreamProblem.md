...
next: false
prev: false
title: "UpstashRateLimitUpstreamProblem"
---
...
> **new UpstashRateLimitUpstreamProblem**(`operation`, `error`): `UpstashRateLimitUpstreamProblem`
...
> `readonly` **code**: `"ratelimit-upstash/upstream-failed"` = `"ratelimit-upstash/upstream-failed"`
