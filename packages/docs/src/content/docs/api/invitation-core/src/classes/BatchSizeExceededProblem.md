...
next: false
prev: false
title: "BatchSizeExceededProblem"
---
...
> **new BatchSizeExceededProblem**(`maxBatchSize`): `BatchSizeExceededProblem`
...
> `readonly` **code**: `"invitation-core/batch-size-exceeded"` = `"invitation-core/batch-size-exceeded"`
