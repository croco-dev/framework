...
next: false
prev: false
title: "InvitationIdempotencyConflictProblem"
---
...
> **new InvitationIdempotencyConflictProblem**(`idempotencyKey`): `InvitationIdempotencyConflictProblem`
...
> `readonly` **code**: `"INVITATION_IDEMPOTENCY_CONFLICT"` = `"INVITATION_IDEMPOTENCY_CONFLICT"`
