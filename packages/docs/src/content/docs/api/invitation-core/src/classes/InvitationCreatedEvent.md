...
> **new InvitationCreatedEvent**(`data`): `InvitationCreatedEvent`
...
> `readonly` **data**: `InvitationCreatedEventData`
...
> `static` **eventName**: `string` = `"invitation.created"`
