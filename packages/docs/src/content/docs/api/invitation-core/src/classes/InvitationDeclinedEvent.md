...
> **new InvitationDeclinedEvent**(`data`): `InvitationDeclinedEvent`
...
> `readonly` **data**: `InvitationDeclinedEventData`
...
> `static` **eventName**: `string` = `"invitation.declined"`
