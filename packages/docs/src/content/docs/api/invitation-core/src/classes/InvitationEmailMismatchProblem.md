...
next: false
prev: false
title: "InvitationEmailMismatchProblem"
---
...
> **new InvitationEmailMismatchProblem**(`invitationId`, `expectedEmail`, `providedEmail`): `InvitationEmailMismatchProblem`
...
> `readonly` **code**: `"INVITATION_EMAIL_MISMATCH"` = `"INVITATION_EMAIL_MISMATCH"`
