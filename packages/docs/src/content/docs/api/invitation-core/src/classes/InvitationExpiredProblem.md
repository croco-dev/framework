...
next: false
prev: false
title: "InvitationExpiredProblem"
---
...
> **new InvitationExpiredProblem**(`invitationId`): `InvitationExpiredProblem`
...
> `readonly` **category**: [`Gone`](/api/problems-core/src/enumerations/problemcategory/#gone) = `ProblemCategory.Gone`
...
> `readonly` **code**: `"INVITATION_EXPIRED"` = `"INVITATION_EXPIRED"`
