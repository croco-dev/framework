...
next: false
prev: false
title: "InvitationCreationFailedProblem"
---
...
> **new InvitationCreationFailedProblem**(`invitationId`, `phase`): `InvitationCreationFailedProblem`
...
`"persistence"` \| `"notification"` \| `"event"`
...
> `readonly` **code**: `"INVITATION_CREATION_FAILED"` = `"INVITATION_CREATION_FAILED"`
