...
next: false
prev: false
title: "DomainAutoJoinRecoveryProblem"
---
...
> **new DomainAutoJoinRecoveryProblem**(`phase`): `DomainAutoJoinRecoveryProblem`
...
> `readonly` **code**: `"DOMAIN_AUTO_JOIN_RECOVERY_FAILED"` = `"DOMAIN_AUTO_JOIN_RECOVERY_FAILED"`
