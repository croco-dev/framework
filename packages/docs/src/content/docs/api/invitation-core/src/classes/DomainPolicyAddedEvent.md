...
> **new DomainPolicyAddedEvent**(`data`): `DomainPolicyAddedEvent`

#### Parameters

##### data

`DomainPolicyAddedEventData`
...
> `readonly` **data**: `DomainPolicyAddedEventData`
...
> `static` **eventName**: `string` = `"invitation.domain_policy_added"`
