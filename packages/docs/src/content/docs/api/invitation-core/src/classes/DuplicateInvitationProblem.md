...
next: false
prev: false
title: "DuplicateInvitationProblem"
---
...
> **new DuplicateInvitationProblem**(`tenantId`, `email`): `DuplicateInvitationProblem`
...
> `readonly` **code**: `"DUPLICATE_INVITATION"` = `"DUPLICATE_INVITATION"`
