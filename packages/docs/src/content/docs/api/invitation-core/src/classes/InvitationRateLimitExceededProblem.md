...
next: false
prev: false
title: "InvitationRateLimitExceededProblem"
---
...
> **new InvitationRateLimitExceededProblem**(`limit`): `InvitationRateLimitExceededProblem`
...
> `readonly` **code**: `"INVITATION_RATE_LIMIT_EXCEEDED"` = `"INVITATION_RATE_LIMIT_EXCEEDED"`
