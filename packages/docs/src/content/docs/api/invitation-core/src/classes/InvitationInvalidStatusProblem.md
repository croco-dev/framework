...
next: false
prev: false
title: "InvitationInvalidStatusProblem"
---
...
> **new InvitationInvalidStatusProblem**(`invitationId`, `status`, `operation`): `InvitationInvalidStatusProblem`
...
> `readonly` **code**: `"INVITATION_INVALID_STATUS"` = `"INVITATION_INVALID_STATUS"`
