...
next: false
prev: false
title: "InvitationAlreadyAcceptedProblem"
---
...
> **new InvitationAlreadyAcceptedProblem**(`invitationId`): `InvitationAlreadyAcceptedProblem`
...
> `readonly` **code**: `"INVITATION_ALREADY_ACCEPTED"` = `"INVITATION_ALREADY_ACCEPTED"`
