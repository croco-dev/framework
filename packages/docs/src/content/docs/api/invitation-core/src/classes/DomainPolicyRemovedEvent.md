...
next: false
prev: false
title: "DomainPolicyRemovedEvent"
---
...
> **new DomainPolicyRemovedEvent**(`data`): `DomainPolicyRemovedEvent`

#### Parameters

##### data

`DomainPolicyRemovedEventData`
...
> `readonly` **data**: `DomainPolicyRemovedEventData`
...
> `static` **eventName**: `string` = `"invitation.domain_policy_removed"`
