...
next: false
prev: false
title: "TestResourceMissingDependencyProblem"
---
...
> **new TestResourceMissingDependencyProblem**(`resourceId`, `requirement`, `cause?`): `TestResourceMissingDependencyProblem`
...
`TestResourceLiveDependencyRequirement`
