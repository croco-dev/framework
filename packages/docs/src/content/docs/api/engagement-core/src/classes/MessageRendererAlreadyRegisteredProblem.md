...
next: false
prev: false
title: "MessageRendererAlreadyRegisteredProblem"
---
...
> **new MessageRendererAlreadyRegisteredProblem**(`messageId`, `existingRendererName`, `rendererName`): `MessageRendererAlreadyRegisteredProblem`
