...
next: false
prev: false
title: "MessageRendererChannelMissingProblem"
---
...
> **new MessageRendererChannelMissingProblem**(`messageId`, `rendererName`, `channel`): `MessageRendererChannelMissingProblem`
