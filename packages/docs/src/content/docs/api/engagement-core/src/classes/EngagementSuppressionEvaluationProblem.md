...
next: false
prev: false
title: "EngagementSuppressionEvaluationProblem"
---
...
> **new EngagementSuppressionEvaluationProblem**(`messageId`, `ref`, `channel`, `cause`): `EngagementSuppressionEvaluationProblem`
