...
next: false
prev: false
title: "CampaignSnapshotIncompleteProblem"
---
...
> **new CampaignSnapshotIncompleteProblem**(`snapshotId`, `state`): `CampaignSnapshotIncompleteProblem`
...
[`CampaignSnapshotState`](/api/engagement-core/src/type-aliases/campaignsnapshotstate/)
