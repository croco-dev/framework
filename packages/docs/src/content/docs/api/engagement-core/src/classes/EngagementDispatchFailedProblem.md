...
> **new EngagementDispatchFailedProblem**(`messageId`, `ref`, `channel`, `channelResults`, `cause`): `EngagementDispatchFailedProblem`
...
readonly [`EngagementChannelResult`](/api/engagement-core/src/type-aliases/engagementchannelresult/)[]
