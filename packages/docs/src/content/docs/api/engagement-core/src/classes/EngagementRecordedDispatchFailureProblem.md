...
next: false
prev: false
title: "EngagementRecordedDispatchFailureProblem"
---
...
> **new EngagementRecordedDispatchFailureProblem**(`dispatch`): `EngagementRecordedDispatchFailureProblem`

#### Parameters

##### dispatch

[`EngagementDispatch`](/api/engagement-core/src/type-aliases/engagementdispatch/)
