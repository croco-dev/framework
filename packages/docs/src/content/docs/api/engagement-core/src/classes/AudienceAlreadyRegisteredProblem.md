...
next: false
prev: false
title: "AudienceAlreadyRegisteredProblem"
---
...
> **new AudienceAlreadyRegisteredProblem**(`audienceId`, `existingAudienceName`, `audienceName`): `AudienceAlreadyRegisteredProblem`
