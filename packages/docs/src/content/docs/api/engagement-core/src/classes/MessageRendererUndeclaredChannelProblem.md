...
next: false
prev: false
title: "MessageRendererUndeclaredChannelProblem"
---
...
> **new MessageRendererUndeclaredChannelProblem**(`messageId`, `rendererName`, `channel`): `MessageRendererUndeclaredChannelProblem`
