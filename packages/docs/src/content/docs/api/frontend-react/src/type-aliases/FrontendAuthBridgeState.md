...
next: false
prev: false
title: "FrontendAuthBridgeState"
---

> **FrontendAuthBridgeState** = `object`
...
> `readonly` **tenant**: [`FrontendTenantState`](/api/frontend-react/src/type-aliases/frontendtenantstate/)
