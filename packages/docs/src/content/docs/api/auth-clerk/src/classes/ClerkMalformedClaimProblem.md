...
next: false
prev: false
title: "ClerkMalformedClaimProblem"
---
...
> **new ClerkMalformedClaimProblem**(`claimName`): `ClerkMalformedClaimProblem`
...
> `readonly` **code**: `"auth-clerk/malformed-claim"` = `"auth-clerk/malformed-claim"`
