...
next: false
prev: false
title: "ClerkWebhookDeliveryInFlightProblem"
---
...
> **new ClerkWebhookDeliveryInFlightProblem**(`deliveryId`, `eventType`): `ClerkWebhookDeliveryInFlightProblem`
...
> `readonly` **code**: `"auth-clerk/webhook-delivery-in-flight"` = `"auth-clerk/webhook-delivery-in-flight"`
