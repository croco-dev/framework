...
next: false
prev: false
title: "ClerkPublicUserDataMissingProblem"
---
...
> **new ClerkPublicUserDataMissingProblem**(): `ClerkPublicUserDataMissingProblem`
...
> `readonly` **code**: `"auth-clerk/public-user-data-missing"` = `"auth-clerk/public-user-data-missing"`
