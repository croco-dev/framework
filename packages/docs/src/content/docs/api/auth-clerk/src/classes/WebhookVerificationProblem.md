...
next: false
prev: false
title: "WebhookVerificationProblem"
---
...
> **new WebhookVerificationProblem**(): `WebhookVerificationProblem`
...
> `readonly` **code**: `"auth-clerk/webhook-verification-failed"` = `"auth-clerk/webhook-verification-failed"`
