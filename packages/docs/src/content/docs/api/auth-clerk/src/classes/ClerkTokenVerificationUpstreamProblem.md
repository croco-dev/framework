...
next: false
prev: false
title: "ClerkTokenVerificationUpstreamProblem"
---
...
> **new ClerkTokenVerificationUpstreamProblem**(`error`, `operation?`): `ClerkTokenVerificationUpstreamProblem`
...
> `readonly` **code**: `"auth-clerk/token-verification-upstream-failed"` = `"auth-clerk/token-verification-upstream-failed"`
