...
> **new InvalidWebhookPayloadProblem**(`eventType?`): `InvalidWebhookPayloadProblem`
...
> `readonly` **code**: `"auth-clerk/invalid-webhook-payload"` = `"auth-clerk/invalid-webhook-payload"`
