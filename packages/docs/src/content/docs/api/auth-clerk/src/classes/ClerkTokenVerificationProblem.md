...
next: false
prev: false
title: "ClerkTokenVerificationProblem"
---
...
> **new ClerkTokenVerificationProblem**(`error?`, `operation?`): `ClerkTokenVerificationProblem`
...
> `readonly` **code**: `"auth-clerk/token-verification-failed"` = `"auth-clerk/token-verification-failed"`
