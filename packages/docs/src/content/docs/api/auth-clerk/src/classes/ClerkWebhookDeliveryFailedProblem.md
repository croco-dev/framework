...
next: false
prev: false
title: "ClerkWebhookDeliveryFailedProblem"
---
...
> **new ClerkWebhookDeliveryFailedProblem**(`deliveryId`, `eventType`): `ClerkWebhookDeliveryFailedProblem`
...
> `readonly` **code**: `"auth-clerk/webhook-delivery-failed"` = `"auth-clerk/webhook-delivery-failed"`
