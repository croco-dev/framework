...
next: false
prev: false
title: "DuplicateTenantMappingProblem"
---
...
> **new DuplicateTenantMappingProblem**(`externalOrgId`, `existingTenantId`, `nextTenantId`): `DuplicateTenantMappingProblem`
...
> `readonly` **code**: `"auth-drizzle/duplicate-tenant-mapping"` = `"auth-drizzle/duplicate-tenant-mapping"`
