...
next: false
prev: false
title: "TenantMappingConflictResolutionProblem"
---
...
> **new TenantMappingConflictResolutionProblem**(`externalOrgId`, `requestedTenantId`): `TenantMappingConflictResolutionProblem`
...
> `readonly` **code**: `"auth-drizzle/tenant-mapping-conflict-resolution-failed"` = `"auth-drizzle/tenant-mapping-conflict-resolution-failed"`
