...
next: false
prev: false
title: "RlsExecuteUnsupportedProblem"
---
...
> **new RlsExecuteUnsupportedProblem**(`configKey`): `RlsExecuteUnsupportedProblem`
...
> `readonly` **code**: `"tx-drizzle/rls-execute-unsupported"` = `"tx-drizzle/rls-execute-unsupported"`
