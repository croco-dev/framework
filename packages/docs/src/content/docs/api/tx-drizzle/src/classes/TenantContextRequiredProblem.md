...
next: false
prev: false
title: "TenantContextRequiredProblem"
---
...
> **new TenantContextRequiredProblem**(): `TenantContextRequiredProblem`
...
> `readonly` **code**: `"tx-drizzle/tenant-context-required"` = `"tx-drizzle/tenant-context-required"`
