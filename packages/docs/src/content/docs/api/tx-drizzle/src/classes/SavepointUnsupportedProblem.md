...
next: false
prev: false
title: "SavepointUnsupportedProblem"
---
...
> **new SavepointUnsupportedProblem**(): `SavepointUnsupportedProblem`
...
> `readonly` **code**: `"tx-drizzle/savepoint-unsupported"` = `"tx-drizzle/savepoint-unsupported"`
