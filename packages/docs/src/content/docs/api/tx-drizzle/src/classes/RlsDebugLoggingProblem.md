...
> **new RlsDebugLoggingProblem**(`phase`, `cause`): `RlsDebugLoggingProblem`

#### Parameters

##### phase

[`RlsDebugLoggingPhase`](/api/tx-drizzle/src/type-aliases/rlsdebugloggingphase/)
...
> `readonly` **code**: `"tx-drizzle/rls-debug-logging-failed"` = `"tx-drizzle/rls-debug-logging-failed"`
