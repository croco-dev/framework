...
next: false
prev: false
title: "MigrationTransactionRequiredProblem"
---
...
> **new MigrationTransactionRequiredProblem**(`direction`): `MigrationTransactionRequiredProblem`
...
`MigrationTransactionRequiredProblem`
...
> `readonly` **code**: `"migration-runner/transaction-required"` = `"migration-runner/transaction-required"`
