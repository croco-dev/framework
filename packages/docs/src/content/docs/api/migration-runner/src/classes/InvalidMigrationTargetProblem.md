...
next: false
prev: false
title: "InvalidMigrationTargetProblem"
---
...
> **new InvalidMigrationTargetProblem**(`target`, `reason`): `InvalidMigrationTargetProblem`
...
`InvalidMigrationTargetReason`

#### Returns

`InvalidMigrationTargetProblem`
...
> `readonly` **code**: `"migration-runner/invalid-target"` = `"migration-runner/invalid-target"`
