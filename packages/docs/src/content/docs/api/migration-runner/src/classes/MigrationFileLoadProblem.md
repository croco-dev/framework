...
next: false
prev: false
title: "MigrationFileLoadProblem"
---
...
> **new MigrationFileLoadProblem**(`moduleUrl`, `cause`): `MigrationFileLoadProblem`
...
> `readonly` **code**: `"migration-runner/file-load-failed"` = `"migration-runner/file-load-failed"`
