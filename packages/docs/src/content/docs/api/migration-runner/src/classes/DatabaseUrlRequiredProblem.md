...
next: false
prev: false
title: "DatabaseUrlRequiredProblem"
---
...
> **new DatabaseUrlRequiredProblem**(): `DatabaseUrlRequiredProblem`

#### Returns

`DatabaseUrlRequiredProblem`
...
> `readonly` **code**: `"migration-runner/database-url-required"` = `"migration-runner/database-url-required"`
