...
next: false
prev: false
title: "UnsupportedMigrationQueryResultProblem"
---
...
> **new UnsupportedMigrationQueryResultProblem**(`context?`): `UnsupportedMigrationQueryResultProblem`

#### Parameters

##### context?

[`UnsupportedMigrationQueryResultContext`](/api/migration-runner/src/type-aliases/unsupportedmigrationqueryresultcontext/)
...
> `readonly` **code**: `"migration-runner/unsupported-query-result"` = `"migration-runner/unsupported-query-result"`
