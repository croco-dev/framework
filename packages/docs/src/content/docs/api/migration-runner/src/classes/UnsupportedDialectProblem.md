...
next: false
prev: false
title: "UnsupportedDialectProblem"
---
...
> **new UnsupportedDialectProblem**(`dialect`): `UnsupportedDialectProblem`
...
> `readonly` **code**: `"migration-runner/unsupported-dialect"` = `"migration-runner/unsupported-dialect"`
