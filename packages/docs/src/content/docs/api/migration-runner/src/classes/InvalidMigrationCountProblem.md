...
next: false
prev: false
title: "InvalidMigrationCountProblem"
---
...
> **new InvalidMigrationCountProblem**(`count`): `InvalidMigrationCountProblem`
...
> `readonly` **code**: `"migration-runner/invalid-count"` = `"migration-runner/invalid-count"`
