...
next: false
prev: false
title: "MissingDownFunctionProblem"
---
...
> **new MissingDownFunctionProblem**(`fileId`, `fileName`): `MissingDownFunctionProblem`
...
> `readonly` **code**: `"migration-runner/missing-down-function"` = `"migration-runner/missing-down-function"`
