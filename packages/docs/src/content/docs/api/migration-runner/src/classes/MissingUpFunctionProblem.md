...
next: false
prev: false
title: "MissingUpFunctionProblem"
---
...
> **new MissingUpFunctionProblem**(`fileId`, `fileName`): `MissingUpFunctionProblem`
...
> `readonly` **code**: `"migration-runner/missing-up-function"` = `"migration-runner/missing-up-function"`
