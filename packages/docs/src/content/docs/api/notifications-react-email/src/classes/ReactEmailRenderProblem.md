...
next: false
prev: false
title: "ReactEmailRenderProblem"
---

Optional React Email rendering for canonical Croco email content.
...
> **new ReactEmailRenderProblem**(`mode`): `ReactEmailRenderProblem`
