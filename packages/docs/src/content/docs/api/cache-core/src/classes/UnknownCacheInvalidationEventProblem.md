...
next: false
prev: false
title: "UnknownCacheInvalidationEventProblem"
---
...
> **new UnknownCacheInvalidationEventProblem**(`eventName`): `UnknownCacheInvalidationEventProblem`
...
> `readonly` **code**: `"cache-core/invalidation-event-unknown"` = `"cache-core/invalidation-event-unknown"`
