...
next: false
prev: false
title: "InvalidCacheConfigurationProblem"
---
...
[`CacheNumericOption`](/api/cache-core/src/type-aliases/cachenumericoption/)
...
> `readonly` **code**: `"cache-core/invalid-configuration"` = `"cache-core/invalid-configuration"`
...
> `readonly` **option**: [`CacheNumericOption`](/api/cache-core/src/type-aliases/cachenumericoption/)
