...
next: false
prev: false
title: "CacheDecoratorConfigProblem"
---
...
> **new CacheDecoratorConfigProblem**(`detail`): `CacheDecoratorConfigProblem`
...
> `readonly` **code**: `"cache-core/invalid-decorator-config"` = `"cache-core/invalid-decorator-config"`
