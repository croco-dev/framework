...
> **new CacheKeyArgumentProblem**(`path`, `reason`): `CacheKeyArgumentProblem`
...
> `readonly` **code**: `"cache-core/cache-key-argument-unsupported"` = `"cache-core/cache-key-argument-unsupported"`
