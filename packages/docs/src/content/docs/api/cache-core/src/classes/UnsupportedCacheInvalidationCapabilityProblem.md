...
next: false
prev: false
title: "UnsupportedCacheInvalidationCapabilityProblem"
---
...
> **new UnsupportedCacheInvalidationCapabilityProblem**(`adapterName`, `operation`): `UnsupportedCacheInvalidationCapabilityProblem`
...
`CacheInvalidationProblemOperation`
...
> `readonly` **code**: `"cache-core/invalidation-capability-unsupported"` = `"cache-core/invalidation-capability-unsupported"`
