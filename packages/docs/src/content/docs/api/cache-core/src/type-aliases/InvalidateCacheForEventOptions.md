...
next: false
prev: false
title: "InvalidateCacheForEventOptions"
---

> **InvalidateCacheForEventOptions** = `object`
...
> `readonly` `optional` **telemetry?**: [`CacheInvalidationTelemetrySink`](/api/cache-core/src/type-aliases/cacheinvalidationtelemetrysink/)
