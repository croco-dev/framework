...
next: false
prev: false
title: "CacheInvalidationGraphProblem"
---
...
> **new CacheInvalidationGraphProblem**(`diagnostics`): `CacheInvalidationGraphProblem`

#### Parameters

##### diagnostics

readonly [`CacheInvalidationDiagnostic`](/api/cache-core/src/type-aliases/cacheinvalidationdiagnostic/)[]
...
> `readonly` **code**: `"cache-core/invalidation-graph-invalid"` = `"cache-core/invalidation-graph-invalid"`
