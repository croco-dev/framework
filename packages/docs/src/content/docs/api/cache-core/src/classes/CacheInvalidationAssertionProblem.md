...
next: false
prev: false
title: "CacheInvalidationAssertionProblem"
---
...
> **new CacheInvalidationAssertionProblem**(`detail`): `CacheInvalidationAssertionProblem`
...
> `readonly` **code**: `"cache-core/invalidation-assertion-failed"` = `"cache-core/invalidation-assertion-failed"`
