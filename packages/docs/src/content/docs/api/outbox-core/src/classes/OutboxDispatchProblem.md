...
> **new OutboxDispatchProblem**(`options`): `OutboxDispatchProblem`

#### Parameters

##### options

[`OutboxDispatchProblemOptions`](/api/outbox-core/src/type-aliases/outboxdispatchproblemoptions/)
