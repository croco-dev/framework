...
next: false
prev: false
title: "BillingStatusMappingProblem"
---
...
> **new BillingStatusMappingProblem**(`status`): `BillingStatusMappingProblem`
...
> `readonly` **code**: `"BILLING_STATUS_MAPPING_FAILED"` = `"BILLING_STATUS_MAPPING_FAILED"`
