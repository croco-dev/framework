...
next: false
prev: false
title: "PolarUsageMeterMappingProblem"
---
...
> **new PolarUsageMeterMappingProblem**(`meterId`, `reason?`): `PolarUsageMeterMappingProblem`
...
`string` = `"No Polar usage meter binding is configured"`
