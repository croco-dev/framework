...
next: false
prev: false
title: "PolarMissingConfigProblem"
---
...
> **new PolarMissingConfigProblem**(`configKey`, `operation?`): `PolarMissingConfigProblem`

#### Parameters

##### configKey

[`PolarConfigKey`](/api/billing-polar/src/type-aliases/polarconfigkey/)
