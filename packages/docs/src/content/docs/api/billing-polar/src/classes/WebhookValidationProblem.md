...
next: false
prev: false
title: "WebhookValidationProblem"
---
...
> **new WebhookValidationProblem**(`reason`): `WebhookValidationProblem`
...
> `readonly` **code**: `"WEBHOOK_VALIDATION_FAILED"` = `"WEBHOOK_VALIDATION_FAILED"`
