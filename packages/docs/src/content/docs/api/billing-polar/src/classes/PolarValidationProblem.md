...
> **new PolarValidationProblem**(`context`, `detail?`): `PolarValidationProblem`

#### Parameters

##### context

[`PolarBillingErrorContext`](/api/billing-polar/src/type-aliases/polarbillingerrorcontext/)

##### detail?

`string` = `"Polar billing request validation failed"`
