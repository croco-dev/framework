...
> `readonly` `optional` **imports?**: readonly `CrocoModule`[]
...
> `readonly` `optional` **providers?**: readonly [`ModuleProvider`](/api/framework-module/src/type-aliases/moduleprovider/)\<`unknown`\>[]
