...
next: false
prev: false
title: "ModuleProviderUnavailableProblem"
---
...
> **new ModuleProviderUnavailableProblem**(`moduleName`, `token`, `cause?`): `ModuleProviderUnavailableProblem`
...
[`ModuleToken`](/api/framework-module/src/type-aliases/moduletoken/)\<`unknown`\>
