...
next: false
prev: false
title: "InvalidDeadLetterPolicyProblem"
---
...
> **new InvalidDeadLetterPolicyProblem**(`option`, `value`): `InvalidDeadLetterPolicyProblem`

#### Parameters

##### option

[`DeadLetterPolicyOption`](/api/events-inmemory/src/type-aliases/deadletterpolicyoption/)
...
> `readonly` **code**: `"events-inmemory/invalid-dead-letter-policy"` = `"events-inmemory/invalid-dead-letter-policy"`
...
> `readonly` **option**: [`DeadLetterPolicyOption`](/api/events-inmemory/src/type-aliases/deadletterpolicyoption/)
