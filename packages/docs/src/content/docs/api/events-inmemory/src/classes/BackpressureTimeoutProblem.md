...
next: false
prev: false
title: "BackpressureTimeoutProblem"
---
...
> **new BackpressureTimeoutProblem**(`detail`): `BackpressureTimeoutProblem`
...
> `readonly` **code**: `"events-inmemory/backpressure-timeout"` = `"events-inmemory/backpressure-timeout"`
...
> `static` **timeout**(`timeoutMs`): `BackpressureTimeoutProblem`
