...
next: false
prev: false
title: "DeadLetterReplayHandlerUnavailableProblem"
---
...
> **new DeadLetterReplayHandlerUnavailableProblem**(`eventName`, `handlerId`): `DeadLetterReplayHandlerUnavailableProblem`
...
> `readonly` **code**: `"events-inmemory/dead-letter-handler-unavailable"` = `"events-inmemory/dead-letter-handler-unavailable"`
