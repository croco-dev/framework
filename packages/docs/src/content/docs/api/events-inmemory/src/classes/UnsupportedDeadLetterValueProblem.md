...
next: false
prev: false
title: "UnsupportedDeadLetterValueProblem"
---
...
> **new UnsupportedDeadLetterValueProblem**(): `UnsupportedDeadLetterValueProblem`
...
> `readonly` **code**: `"events-inmemory/unsupported-dead-letter-value"` = `"events-inmemory/unsupported-dead-letter-value"`
