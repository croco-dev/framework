...
next: false
prev: false
title: "DeadLetterQueueNotConfiguredProblem"
---
...
> **new DeadLetterQueueNotConfiguredProblem**(): `DeadLetterQueueNotConfiguredProblem`
...
> `readonly` **code**: `"events-inmemory/dead-letter-queue-not-configured"` = `"events-inmemory/dead-letter-queue-not-configured"`
