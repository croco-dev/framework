...
next: false
prev: false
title: "InvalidEventBusConfigurationProblem"
---
...
> **new InvalidEventBusConfigurationProblem**(`option`, `value`): `InvalidEventBusConfigurationProblem`

#### Parameters

##### option

[`EventBusNumericOption`](/api/events-inmemory/src/type-aliases/eventbusnumericoption/)
...
> `readonly` **code**: `"events-inmemory/invalid-configuration"` = `"events-inmemory/invalid-configuration"`
...
> `readonly` **option**: [`EventBusNumericOption`](/api/events-inmemory/src/type-aliases/eventbusnumericoption/)
