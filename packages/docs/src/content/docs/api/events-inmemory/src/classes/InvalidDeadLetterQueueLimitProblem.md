...
next: false
prev: false
title: "InvalidDeadLetterQueueLimitProblem"
---
...
> **new InvalidDeadLetterQueueLimitProblem**(`value`): `InvalidDeadLetterQueueLimitProblem`
...
> `readonly` **code**: `"events-inmemory/invalid-dead-letter-limit"` = `"events-inmemory/invalid-dead-letter-limit"`
