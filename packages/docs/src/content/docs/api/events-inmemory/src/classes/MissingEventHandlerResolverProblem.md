...
next: false
prev: false
title: "MissingEventHandlerResolverProblem"
---
...
> **new MissingEventHandlerResolverProblem**(`handlerName`): `MissingEventHandlerResolverProblem`
...
> `readonly` **code**: `"events-inmemory/missing-handler-resolver"` = `"events-inmemory/missing-handler-resolver"`
