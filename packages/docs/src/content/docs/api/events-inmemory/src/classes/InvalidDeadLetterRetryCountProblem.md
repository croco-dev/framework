...
next: false
prev: false
title: "InvalidDeadLetterRetryCountProblem"
---
...
> **new InvalidDeadLetterRetryCountProblem**(`retryCount`, `maxRetries`): `InvalidDeadLetterRetryCountProblem`
...
> `readonly` **code**: `"events-inmemory/invalid-dead-letter-retry-count"` = `"events-inmemory/invalid-dead-letter-retry-count"`
