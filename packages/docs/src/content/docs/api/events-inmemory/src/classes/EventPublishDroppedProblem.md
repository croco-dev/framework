...
next: false
prev: false
title: "EventPublishDroppedProblem"
---
...
> **new EventPublishDroppedProblem**(`eventName`, `deliveredCount`, `droppedCount`, `failures`): `EventPublishDroppedProblem`
...
> `readonly` **code**: `"events-inmemory/publish-dropped"` = `"events-inmemory/publish-dropped"`
