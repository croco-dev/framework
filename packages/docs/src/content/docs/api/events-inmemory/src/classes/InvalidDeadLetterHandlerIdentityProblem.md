...
> **new InvalidDeadLetterHandlerIdentityProblem**(`handlerId`): `InvalidDeadLetterHandlerIdentityProblem`
...
> `readonly` **code**: `"events-inmemory/invalid-dead-letter-handler-identity"` = `"events-inmemory/invalid-dead-letter-handler-identity"`
