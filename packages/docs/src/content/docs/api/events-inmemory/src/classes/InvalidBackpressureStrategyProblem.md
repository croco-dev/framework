...
next: false
prev: false
title: "InvalidBackpressureStrategyProblem"
---
...
> **new InvalidBackpressureStrategyProblem**(`value`): `InvalidBackpressureStrategyProblem`
...
> `readonly` **code**: `"events-inmemory/invalid-backpressure-strategy"` = `"events-inmemory/invalid-backpressure-strategy"`
