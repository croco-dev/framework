...
next: false
prev: false
title: "DataGovernanceValidationProblem"
---
...
> **new DataGovernanceValidationProblem**(`report`): `DataGovernanceValidationProblem`

#### Parameters

##### report

[`DataGovernanceValidationReport`](/api/governance-core/src/type-aliases/datagovernancevalidationreport/)
