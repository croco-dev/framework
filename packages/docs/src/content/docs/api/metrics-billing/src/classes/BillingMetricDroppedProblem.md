...
next: false
prev: false
title: "BillingMetricDroppedProblem"
---
...
> **new BillingMetricDroppedProblem**(`options`): `BillingMetricDroppedProblem`

#### Parameters

##### options

[`BillingMetricDroppedProblemOptions`](/api/metrics-billing/src/type-aliases/billingmetricdroppedproblemoptions/)
...
> `readonly` **code**: `"metrics-billing/metric-dropped"` = `"metrics-billing/metric-dropped"`
