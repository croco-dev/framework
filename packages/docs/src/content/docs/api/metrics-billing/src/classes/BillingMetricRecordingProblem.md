...
next: false
prev: false
title: "BillingMetricRecordingProblem"
---
...
> **new BillingMetricRecordingProblem**(`options`): `BillingMetricRecordingProblem`

#### Parameters

##### options

[`BillingMetricRecordingProblemOptions`](/api/metrics-billing/src/type-aliases/billingmetricrecordingproblemoptions/)
...
> `readonly` **code**: `"metrics-billing/recording-failed"` = `"metrics-billing/recording-failed"`
