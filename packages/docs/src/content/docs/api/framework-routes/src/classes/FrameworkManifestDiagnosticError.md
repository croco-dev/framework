...
next: false
prev: false
title: "FrameworkManifestDiagnosticError"
---
...
> **new FrameworkManifestDiagnosticError**(`diagnostics`): `FrameworkManifestDiagnosticError`

#### Parameters

##### diagnostics

readonly [`FrameworkManifestDiagnostic`](/api/framework-routes/src/type-aliases/frameworkmanifestdiagnostic/)[]
