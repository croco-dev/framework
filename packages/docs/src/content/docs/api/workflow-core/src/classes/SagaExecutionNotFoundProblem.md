...
next: false
prev: false
title: "SagaExecutionNotFoundProblem"
---
...
> **new SagaExecutionNotFoundProblem**(`executionId`): `SagaExecutionNotFoundProblem`
...
> `readonly` **code**: `"workflow-core/saga-execution-not-found"` = `"workflow-core/saga-execution-not-found"`
