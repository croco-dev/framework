...
> **new WorkflowNotFoundProblem**(`workflowName`): `WorkflowNotFoundProblem`
...
> `readonly` **code**: `"workflow-core/workflow-not-found"` = `"workflow-core/workflow-not-found"`
