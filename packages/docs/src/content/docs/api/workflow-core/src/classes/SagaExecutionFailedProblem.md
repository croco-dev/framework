...
next: false
prev: false
title: "SagaExecutionFailedProblem"
---
...
> **new SagaExecutionFailedProblem**(`sagaName`, `executionId`, `failure`, `options`): `SagaExecutionFailedProblem`
...
[`SagaFailure`](/api/workflow-core/src/type-aliases/sagafailure/)

##### options

###### compensationFailures

readonly [`SagaFailure`](/api/workflow-core/src/type-aliases/sagafailure/)[]

###### status

[`SagaExecutionStatus`](/api/workflow-core/src/type-aliases/sagaexecutionstatus/)
