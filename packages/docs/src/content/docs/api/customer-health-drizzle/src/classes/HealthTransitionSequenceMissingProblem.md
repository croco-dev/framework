...
next: false
prev: false
title: "HealthTransitionSequenceMissingProblem"
---
...
> **new HealthTransitionSequenceMissingProblem**(): `HealthTransitionSequenceMissingProblem`
...
> `readonly` **code**: `"customer-health-drizzle/transition-sequence-missing"` = `"customer-health-drizzle/transition-sequence-missing"`
