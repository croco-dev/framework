...
next: false
prev: false
title: "InvalidMeteringInputProblem"
---
...
> **new InvalidMeteringInputProblem**(`input`, `value`, `expected`): `InvalidMeteringInputProblem`
...
> `readonly` **code**: `"customer-health-drizzle/invalid-metering-input"` = `"customer-health-drizzle/invalid-metering-input"`
