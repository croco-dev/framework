...
next: false
prev: false
title: "ArchitecturePolicyPackageJsonParseProblem"
---
...
> **new ArchitecturePolicyPackageJsonParseProblem**(`packageJsonPath`, `cause?`): `ArchitecturePolicyPackageJsonParseProblem`
