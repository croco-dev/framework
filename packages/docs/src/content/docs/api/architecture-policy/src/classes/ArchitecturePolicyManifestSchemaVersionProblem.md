...
next: false
prev: false
title: "ArchitecturePolicyManifestSchemaVersionProblem"
---
...
> **new ArchitecturePolicyManifestSchemaVersionProblem**(`actualSchemaVersion`): `ArchitecturePolicyManifestSchemaVersionProblem`
