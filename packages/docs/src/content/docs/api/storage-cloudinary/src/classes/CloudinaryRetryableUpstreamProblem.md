...
next: false
prev: false
title: "CloudinaryRetryableUpstreamProblem"
---
...
> **new CloudinaryRetryableUpstreamProblem**(`context`): `CloudinaryRetryableUpstreamProblem`

#### Parameters

##### context

[`CloudinaryStorageErrorContext`](/api/storage-cloudinary/src/type-aliases/cloudinarystorageerrorcontext/)
