...
next: false
prev: false
title: "CloudinaryMissingConfigProblem"
---
...
> **new CloudinaryMissingConfigProblem**(`configKey`, `operation?`): `CloudinaryMissingConfigProblem`

#### Parameters

##### configKey

[`CloudinaryConfigKey`](/api/storage-cloudinary/src/type-aliases/cloudinaryconfigkey/)
