...
next: false
prev: false
title: "InvalidUserCarryingCapacityMetricProblem"
---
...
> **new InvalidUserCarryingCapacityMetricProblem**(`field`, `value`): `InvalidUserCarryingCapacityMetricProblem`

#### Parameters

##### field

`"nrr"` \| `"dailyChurnRate"` \| `"capacity"`
...
> `readonly` **code**: `"metrics-core/invalid-user-carrying-capacity-metric"` = `"metrics-core/invalid-user-carrying-capacity-metric"`
