...
next: false
prev: false
title: "RetentionMetricsUnavailableProblem"
---
...
> **new RetentionMetricsUnavailableProblem**(`detail?`): `RetentionMetricsUnavailableProblem`

#### Parameters

##### detail?

`string` = `"Retention metrics are not available until full retention calculation is implemented"`
...
> `readonly` **code**: `"metrics-core/retention-metrics-unavailable"` = `"metrics-core/retention-metrics-unavailable"`
