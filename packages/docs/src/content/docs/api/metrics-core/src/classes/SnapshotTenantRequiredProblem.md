...
next: false
prev: false
title: "SnapshotTenantRequiredProblem"
---
...
> **new SnapshotTenantRequiredProblem**(): `SnapshotTenantRequiredProblem`
...
> `readonly` **code**: `"metrics-core/snapshot-tenant-required"` = `"metrics-core/snapshot-tenant-required"`
