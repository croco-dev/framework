...
next: false
prev: false
title: "InvalidCarryingCapacityConfigProblem"
---
...
> **new InvalidCarryingCapacityConfigProblem**(`field`, `value`): `InvalidCarryingCapacityConfigProblem`

#### Parameters

##### field

`"lookbackDays"` \| `"lookbackMonths"`
...
> `readonly` **code**: `"metrics-core/invalid-carrying-capacity-config"` = `"metrics-core/invalid-carrying-capacity-config"`
