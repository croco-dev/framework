...
> **new MixedCurrencyMRRProblem**(`expectedCurrency`, `actualCurrency`): `MixedCurrencyMRRProblem`
...
> `readonly` **code**: `"metrics-core/mixed-currency-mrr"` = `"metrics-core/mixed-currency-mrr"`
