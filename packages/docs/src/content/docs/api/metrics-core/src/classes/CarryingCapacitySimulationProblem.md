...
next: false
prev: false
title: "CarryingCapacitySimulationProblem"
---
...
> **new CarryingCapacitySimulationProblem**(`detail`): `CarryingCapacitySimulationProblem`
...
> `readonly` **code**: `"metrics-core/carrying-capacity-simulation-error"` = `"metrics-core/carrying-capacity-simulation-error"`
