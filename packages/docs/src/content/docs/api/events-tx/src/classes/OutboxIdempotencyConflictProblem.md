...
next: false
prev: false
title: "OutboxIdempotencyConflictProblem"
---
...
> **new OutboxIdempotencyConflictProblem**(`idempotencyKey`, `conflictingFields`): `OutboxIdempotencyConflictProblem`
...
readonly [`OutboxIdempotencyField`](/api/events-tx/src/type-aliases/outboxidempotencyfield/)[]
...
> `readonly` **code**: `"events-tx/outbox-idempotency-conflict"` = `"events-tx/outbox-idempotency-conflict"`
...
> `readonly` **conflictingFields**: readonly [`OutboxIdempotencyField`](/api/events-tx/src/type-aliases/outboxidempotencyfield/)[]
