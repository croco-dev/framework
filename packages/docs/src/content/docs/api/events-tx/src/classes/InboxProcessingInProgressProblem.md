...
next: false
prev: false
title: "InboxProcessingInProgressProblem"
---
...
> **new InboxProcessingInProgressProblem**(`consumerId`, `inboxKey`, `lockedUntil`): `InboxProcessingInProgressProblem`
...
> `readonly` **code**: `"events-tx/inbox-processing-in-progress"` = `"events-tx/inbox-processing-in-progress"`
