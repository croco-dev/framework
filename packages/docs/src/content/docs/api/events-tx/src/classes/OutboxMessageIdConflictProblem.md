...
next: false
prev: false
title: "OutboxMessageIdConflictProblem"
---
...
> **new OutboxMessageIdConflictProblem**(`id`): `OutboxMessageIdConflictProblem`
...
> `readonly` **code**: `"events-tx/outbox-message-id-conflict"` = `"events-tx/outbox-message-id-conflict"`
