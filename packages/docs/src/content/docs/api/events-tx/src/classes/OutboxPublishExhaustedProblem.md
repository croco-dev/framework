...
next: false
prev: false
title: "OutboxPublishExhaustedProblem"
---
...
> **new OutboxPublishExhaustedProblem**(`messageId`, `attempts`, `cause?`): `OutboxPublishExhaustedProblem`
...
> `readonly` **code**: `"events-tx/outbox-publish-exhausted"` = `"events-tx/outbox-publish-exhausted"`
