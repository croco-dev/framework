...
next: false
prev: false
title: "InboxClaimConflictProblem"
---
...
> **new InboxClaimConflictProblem**(`consumerId`, `inboxKey`, `expectedAttempts`, `actualAttempts`, `actualStatus`): `InboxClaimConflictProblem`
...
[`InboxMessageStatus`](/api/events-tx/src/type-aliases/inboxmessagestatus/)
...
> `readonly` **code**: `"events-tx/inbox-claim-conflict"` = `"events-tx/inbox-claim-conflict"`
