...
next: false
prev: false
title: "InMemoryTransactionalEventStore"
---
...
- [`TransactionalEventStore`](/api/events-tx/src/interfaces/transactionaleventstore/)\<[`InMemoryTransactionalEventStoreClient`](/api/events-tx/src/type-aliases/inmemorytransactionaleventstoreclient/)\>

## Constructors

### Constructor

> **new InMemoryTransactionalEventStore**(): `InMemoryTransactionalEventStore`
...
> **createTxAdapter**(): [`TxAdapter`](/api/tx-core/src/interfaces/txadapter/)\<[`InMemoryTransactionalEventStoreClient`](/api/events-tx/src/type-aliases/inmemorytransactionaleventstoreclient/)\>
