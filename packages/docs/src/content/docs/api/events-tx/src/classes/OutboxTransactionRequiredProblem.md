...
next: false
prev: false
title: "OutboxTransactionRequiredProblem"
---
...
> **new OutboxTransactionRequiredProblem**(): `OutboxTransactionRequiredProblem`
...
> `readonly` **code**: `"events-tx/outbox-transaction-required"` = `"events-tx/outbox-transaction-required"`
