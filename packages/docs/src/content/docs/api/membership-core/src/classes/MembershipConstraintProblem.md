...
next: false
prev: false
title: "MembershipConstraintProblem"
---
...
멤버십 제약 조건 위반 시 발생하는 기본 문제 클래스입니다.
...
- [`LastOwnerCannotBeRemovedProblem`](/api/membership-core/src/classes/lastownercannotberemovedproblem/)

## Constructors

### Constructor

> **new MembershipConstraintProblem**(`detail`, `extensions?`, `code?`): `MembershipConstraintProblem`
