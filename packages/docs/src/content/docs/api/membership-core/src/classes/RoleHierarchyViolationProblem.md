...
next: false
prev: false
title: "RoleHierarchyViolationProblem"
---
...
테넌트의 좌석 제한을 초과하여 멤버를 추가하려 할 때 발생하는 문제입니다.
...
> **new RoleHierarchyViolationProblem**(`fromRole`, `toRole`, `operation`): `RoleHierarchyViolationProblem`
