...
next: false
prev: false
title: "OnboardingStepCompletionConflictProblem"
---
...
> **new OnboardingStepCompletionConflictProblem**(`onboardingId`, `stepId`): `OnboardingStepCompletionConflictProblem`
...
> `readonly` **code**: `"onboarding/step-completion-conflict"` = `"onboarding/step-completion-conflict"`
