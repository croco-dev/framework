...
next: false
prev: false
title: "OnboardingStepNotFoundProblem"
---
...
> **new OnboardingStepNotFoundProblem**(`onboardingId`, `stepId`): `OnboardingStepNotFoundProblem`
...
> `readonly` **code**: `"onboarding/step-not-found"` = `"onboarding/step-not-found"`
