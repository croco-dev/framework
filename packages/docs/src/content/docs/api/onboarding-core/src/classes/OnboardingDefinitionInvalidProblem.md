...
next: false
prev: false
title: "OnboardingDefinitionInvalidProblem"
---
...
> **new OnboardingDefinitionInvalidProblem**(`onboardingId`, `stepId`, `reason`): `OnboardingDefinitionInvalidProblem`
...
[`OnboardingDefinitionInvalidReason`](/api/onboarding-core/src/type-aliases/onboardingdefinitioninvalidreason/)
...
> `readonly` **code**: `"onboarding/definition-invalid"` = `"onboarding/definition-invalid"`
