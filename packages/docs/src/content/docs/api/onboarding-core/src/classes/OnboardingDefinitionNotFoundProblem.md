...
next: false
prev: false
title: "OnboardingDefinitionNotFoundProblem"
---
...
> **new OnboardingDefinitionNotFoundProblem**(`onboardingId`): `OnboardingDefinitionNotFoundProblem`
...
> `readonly` **code**: `"onboarding/definition-not-found"` = `"onboarding/definition-not-found"`
