...
next: false
prev: false
title: "OnboardingContextRequiredProblem"
---
...
> **new OnboardingContextRequiredProblem**(): `OnboardingContextRequiredProblem`
...
> `readonly` **code**: `"onboarding/context-required"` = `"onboarding/context-required"`
