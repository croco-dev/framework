...
next: false
prev: false
title: "QStashBatchConfigProblem"
---
...
> **new QStashBatchConfigProblem**(`configKey`): `QStashBatchConfigProblem`
...
> `readonly` **code**: `"batch-qstash/missing-config"` = `"batch-qstash/missing-config"`
