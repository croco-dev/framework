...
next: false
prev: false
title: "QStashBatchValidationProblem"
---
...
> **new QStashBatchValidationProblem**(`message`): `QStashBatchValidationProblem`
...
> `readonly` **code**: `"batch-qstash/invalid-publish-request"` = `"batch-qstash/invalid-publish-request"`
