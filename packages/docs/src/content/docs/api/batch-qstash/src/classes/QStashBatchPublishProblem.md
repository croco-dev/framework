...
next: false
prev: false
title: "QStashBatchPublishProblem"
---
...
> **new QStashBatchPublishProblem**(`operation`, `error`): `QStashBatchPublishProblem`
...
> `readonly` **code**: `"batch-qstash/publish-failed"` = `"batch-qstash/publish-failed"`
