...
> **new DocumentIndexedEvent**(`indexName`, `documentId`, `tenantId`, `payload`): `DocumentIndexedEvent`
...
> `static` **eventName**: `string` = `"search.document_indexed"`
