...
next: false
prev: false
title: "SearchTransformRegistrationConflictProblem"
---
...
> **new SearchTransformRegistrationConflictProblem**(`id`, `registeredDefaultSuffix`, `attemptedDefaultSuffix`): `SearchTransformRegistrationConflictProblem`
