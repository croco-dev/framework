...
next: false
prev: false
title: "TransformNotFoundProblem"
---
...
> **new TransformNotFoundProblem**(`id`): `TransformNotFoundProblem`
...
> `readonly` **code**: `"search-core/transform-not-found"` = `"search-core/transform-not-found"`
