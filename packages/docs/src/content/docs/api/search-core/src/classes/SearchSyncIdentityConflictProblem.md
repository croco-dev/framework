...
next: false
prev: false
title: "SearchSyncIdentityConflictProblem"
---
...
> **new SearchSyncIdentityConflictProblem**(`source`): `SearchSyncIdentityConflictProblem`

#### Parameters

##### source

[`SearchSyncIdentityConflictSource`](/api/search-core/src/type-aliases/searchsyncidentityconflictsource/)
