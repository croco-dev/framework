...
next: false
prev: false
title: "SearchableIndexConflictProblem"
---
...
> **new SearchableIndexConflictProblem**(`indexName`, `declarations`): `SearchableIndexConflictProblem`
...
readonly [`SearchableIndexDeclaration`](/api/search-core/src/type-aliases/searchableindexdeclaration/)[]
