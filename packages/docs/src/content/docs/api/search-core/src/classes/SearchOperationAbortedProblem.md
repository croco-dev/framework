...
next: false
prev: false
title: "SearchOperationAbortedProblem"
---
...
> **new SearchOperationAbortedProblem**(`operation`, `cause?`): `SearchOperationAbortedProblem`

#### Parameters

##### operation

[`SearchOperation`](/api/search-core/src/type-aliases/searchoperation/)
...
> `readonly` `static` **CODE**: `"search-core/operation-aborted"` = `"search-core/operation-aborted"`
