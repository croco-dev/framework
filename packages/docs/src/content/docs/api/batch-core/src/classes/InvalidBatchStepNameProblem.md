...
next: false
prev: false
title: "InvalidBatchStepNameProblem"
---
...
> **new InvalidBatchStepNameProblem**(`stepName`): `InvalidBatchStepNameProblem`
...
> `readonly` **code**: `"batch-core/invalid-step-name"` = `"batch-core/invalid-step-name"`
