...
next: false
prev: false
title: "InvalidBatchChunkSizeProblem"
---
...
> **new InvalidBatchChunkSizeProblem**(`chunkSize`): `InvalidBatchChunkSizeProblem`
...
> `readonly` **code**: `"batch-core/invalid-chunk-size"` = `"batch-core/invalid-chunk-size"`
