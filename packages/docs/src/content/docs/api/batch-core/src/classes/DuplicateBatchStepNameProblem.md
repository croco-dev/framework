...
next: false
prev: false
title: "DuplicateBatchStepNameProblem"
---
...
> **new DuplicateBatchStepNameProblem**(`stepName`): `DuplicateBatchStepNameProblem`
...
> `readonly` **code**: `"batch-core/duplicate-step-name"` = `"batch-core/duplicate-step-name"`
