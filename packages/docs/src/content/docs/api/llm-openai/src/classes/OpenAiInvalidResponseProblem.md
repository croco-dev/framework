...
next: false
prev: false
title: "OpenAiInvalidResponseProblem"
---
...
> **new OpenAiInvalidResponseProblem**(`operation`, `reason`): `OpenAiInvalidResponseProblem`
...
> `readonly` `static` **CODE**: `"llm-openai/invalid-response"` = `"llm-openai/invalid-response"`
