...
> **new OpenAiRateLimitProblem**(`metadata`): `OpenAiRateLimitProblem`

#### Parameters

##### metadata

`OpenAiErrorMetadata` & `object`
...
> `readonly` `static` **CODE**: `"llm-openai/rate-limited"` = `"llm-openai/rate-limited"`
