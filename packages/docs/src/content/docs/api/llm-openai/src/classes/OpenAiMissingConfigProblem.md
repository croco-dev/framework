...
next: false
prev: false
title: "OpenAiMissingConfigProblem"
---
...
> **new OpenAiMissingConfigProblem**(`configKey`): `OpenAiMissingConfigProblem`
...
> `readonly` `static` **CODE**: `"llm-openai/missing-config"` = `"llm-openai/missing-config"`
