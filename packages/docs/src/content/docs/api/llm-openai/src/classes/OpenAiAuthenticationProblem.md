...
next: false
prev: false
title: "OpenAiAuthenticationProblem"
---
...
> **new OpenAiAuthenticationProblem**(`metadata`): `OpenAiAuthenticationProblem`
...
> `readonly` `static` **CODE**: `"llm-openai/authentication-failed"` = `"llm-openai/authentication-failed"`
