...
next: false
prev: false
title: "OpenAiRetryableUpstreamProblem"
---
...
> **new OpenAiRetryableUpstreamProblem**(`metadata`): `OpenAiRetryableUpstreamProblem`
...
> `readonly` `static` **CODE**: `"llm-openai/retryable-upstream"` = `"llm-openai/retryable-upstream"`
