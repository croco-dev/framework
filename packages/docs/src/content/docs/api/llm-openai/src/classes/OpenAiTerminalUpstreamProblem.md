...
next: false
prev: false
title: "OpenAiTerminalUpstreamProblem"
---
...
> **new OpenAiTerminalUpstreamProblem**(`metadata`): `OpenAiTerminalUpstreamProblem`
...
> `readonly` `static` **CODE**: `"llm-openai/terminal-upstream"` = `"llm-openai/terminal-upstream"`
