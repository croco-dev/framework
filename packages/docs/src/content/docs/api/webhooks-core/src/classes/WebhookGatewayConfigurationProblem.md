...
next: false
prev: false
title: "WebhookGatewayConfigurationProblem"
---
...
> **new WebhookGatewayConfigurationProblem**(`reason`, `extensions?`): `WebhookGatewayConfigurationProblem`
...
`WebhookProblem.stackTraceLimit`
...
`WebhookProblem.prepareStackTrace`
