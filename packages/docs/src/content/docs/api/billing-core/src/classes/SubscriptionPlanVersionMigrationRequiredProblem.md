...
next: false
prev: false
title: "SubscriptionPlanVersionMigrationRequiredProblem"
---
...
> **new SubscriptionPlanVersionMigrationRequiredProblem**(`externalSubscriptionId`): `SubscriptionPlanVersionMigrationRequiredProblem`
...
> `readonly` **code**: `"billing/subscription-plan-version-migration-required"` = `"billing/subscription-plan-version-migration-required"`
