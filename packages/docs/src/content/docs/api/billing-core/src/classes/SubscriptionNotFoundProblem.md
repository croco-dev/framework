...
next: false
prev: false
title: "SubscriptionNotFoundProblem"
---
...
> **new SubscriptionNotFoundProblem**(`tenantId`): `SubscriptionNotFoundProblem`
...
> `readonly` **code**: `"billing/subscription-not-found"` = `"billing/subscription-not-found"`
