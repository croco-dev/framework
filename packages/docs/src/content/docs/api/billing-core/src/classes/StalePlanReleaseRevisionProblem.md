...
next: false
prev: false
title: "StalePlanReleaseRevisionProblem"
---
...
> **new StalePlanReleaseRevisionProblem**(`ref`, `expected`, `actual`): `StalePlanReleaseRevisionProblem`
...
> `readonly` **code**: `"billing/stale-plan-release-revision"` = `"billing/stale-plan-release-revision"`
