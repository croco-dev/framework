...
next: false
prev: false
title: "SubscriptionQuantityReconciliationFailedProblem"
---
...
> **new SubscriptionQuantityReconciliationFailedProblem**(`externalSubscriptionId`, `cause?`): `SubscriptionQuantityReconciliationFailedProblem`
...
> `readonly` **code**: `"billing/subscription-quantity-reconciliation-failed"` = `"billing/subscription-quantity-reconciliation-failed"`
