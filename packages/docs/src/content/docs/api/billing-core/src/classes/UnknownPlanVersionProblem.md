...
next: false
prev: false
title: "UnknownPlanVersionProblem"
---
...
> **new UnknownPlanVersionProblem**(`ref`): `UnknownPlanVersionProblem`
...
> `readonly` **code**: `"billing/unknown-plan-version"` = `"billing/unknown-plan-version"`
