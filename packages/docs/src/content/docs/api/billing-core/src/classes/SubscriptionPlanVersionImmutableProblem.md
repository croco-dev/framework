...
next: false
prev: false
title: "SubscriptionPlanVersionImmutableProblem"
---
...
> **new SubscriptionPlanVersionImmutableProblem**(`externalSubscriptionId`, `currentRef`, `requestedRef`): `SubscriptionPlanVersionImmutableProblem`
...
> `readonly` **code**: `"billing/subscription-plan-version-immutable"` = `"billing/subscription-plan-version-immutable"`
