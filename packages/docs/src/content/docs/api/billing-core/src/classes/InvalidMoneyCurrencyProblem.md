...
next: false
prev: false
title: "InvalidMoneyCurrencyProblem"
---
...
> **new InvalidMoneyCurrencyProblem**(`currency`): `InvalidMoneyCurrencyProblem`
...
> `readonly` **code**: `"billing/invalid-money-currency"` = `"billing/invalid-money-currency"`
