...
next: false
prev: false
title: "UnknownPlanVersionMappingProblem"
---
...
> **new UnknownPlanVersionMappingProblem**(`provider`, `productId`, `priceIds?`): `UnknownPlanVersionMappingProblem`
...
> `readonly` **code**: `"billing/unknown-plan-version-mapping"` = `"billing/unknown-plan-version-mapping"`
