...
next: false
prev: false
title: "MoneyCurrencyMismatchProblem"
---
...
> **new MoneyCurrencyMismatchProblem**(`expectedCurrency`, `actualCurrency`): `MoneyCurrencyMismatchProblem`
...
> `readonly` **code**: `"billing/money-currency-mismatch"` = `"billing/money-currency-mismatch"`
