...
next: false
prev: false
title: "OverlappingPlanEffectivePeriodProblem"
---
...
> **new OverlappingPlanEffectivePeriodProblem**(`ref`, `conflictingRef`): `OverlappingPlanEffectivePeriodProblem`
...
> `readonly` **code**: `"billing/overlapping-plan-effective-period"` = `"billing/overlapping-plan-effective-period"`
