...
next: false
prev: false
title: "SubscriptionQuantityReconciliationConflictProblem"
---
...
> **new SubscriptionQuantityReconciliationConflictProblem**(`externalSubscriptionId`, `sourceVersion`): `SubscriptionQuantityReconciliationConflictProblem`
...
> `readonly` **code**: `"billing/subscription-quantity-reconciliation-conflict"` = `"billing/subscription-quantity-reconciliation-conflict"`
