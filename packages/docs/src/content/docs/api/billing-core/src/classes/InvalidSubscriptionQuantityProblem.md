...
next: false
prev: false
title: "InvalidSubscriptionQuantityProblem"
---
...
> **new InvalidSubscriptionQuantityProblem**(`reason`): `InvalidSubscriptionQuantityProblem`
...
> `readonly` **code**: `"billing/invalid-subscription-quantity"` = `"billing/invalid-subscription-quantity"`
