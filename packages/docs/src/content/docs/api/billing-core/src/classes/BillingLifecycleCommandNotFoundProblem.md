...
next: false
prev: false
title: "BillingLifecycleCommandNotFoundProblem"
---
...
> **new BillingLifecycleCommandNotFoundProblem**(`idempotencyKey`): `BillingLifecycleCommandNotFoundProblem`
...
> `readonly` **code**: `"billing/lifecycle-command-not-found"` = `"billing/lifecycle-command-not-found"`
