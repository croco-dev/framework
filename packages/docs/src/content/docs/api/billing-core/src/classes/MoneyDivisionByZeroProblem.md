...
next: false
prev: false
title: "MoneyDivisionByZeroProblem"
---
...
> **new MoneyDivisionByZeroProblem**(): `MoneyDivisionByZeroProblem`
...
> `readonly` **code**: `"billing/money-division-by-zero"` = `"billing/money-division-by-zero"`
