...
next: false
prev: false
title: "SubscriptionQuantityProviderSourceAheadProblem"
---
...
> **new SubscriptionQuantityProviderSourceAheadProblem**(`externalSubscriptionId`, `localSourceVersion`, `providerSourceVersion`): `SubscriptionQuantityProviderSourceAheadProblem`
...
> `readonly` **code**: `"billing/subscription-quantity-provider-source-ahead"` = `"billing/subscription-quantity-provider-source-ahead"`
