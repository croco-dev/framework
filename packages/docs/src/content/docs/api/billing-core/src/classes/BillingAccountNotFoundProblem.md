...
next: false
prev: false
title: "BillingAccountNotFoundProblem"
---
...
> **new BillingAccountNotFoundProblem**(`tenantId`): `BillingAccountNotFoundProblem`
...
> `readonly` **code**: `"billing/account-not-found"` = `"billing/account-not-found"`
