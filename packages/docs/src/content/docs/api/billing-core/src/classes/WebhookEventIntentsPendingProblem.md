...
next: false
prev: false
title: "WebhookEventIntentsPendingProblem"
---
...
> **new WebhookEventIntentsPendingProblem**(`eventId`): `WebhookEventIntentsPendingProblem`
...
> `readonly` **code**: `"billing/webhook-event-intents-pending"` = `"billing/webhook-event-intents-pending"`
