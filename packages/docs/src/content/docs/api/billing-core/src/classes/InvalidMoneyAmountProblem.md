...
next: false
prev: false
title: "InvalidMoneyAmountProblem"
---
...
> **new InvalidMoneyAmountProblem**(`amount`): `InvalidMoneyAmountProblem`
...
> `readonly` **code**: `"billing/invalid-money-amount"` = `"billing/invalid-money-amount"`
