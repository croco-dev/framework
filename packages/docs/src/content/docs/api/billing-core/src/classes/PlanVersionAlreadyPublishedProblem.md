...
next: false
prev: false
title: "PlanVersionAlreadyPublishedProblem"
---
...
> **new PlanVersionAlreadyPublishedProblem**(`ref`): `PlanVersionAlreadyPublishedProblem`
...
> `readonly` **code**: `"billing/plan-version-already-published"` = `"billing/plan-version-already-published"`
