...
next: false
prev: false
title: "SubscriptionPlanVersionResolutionProblem"
---
...
> **new SubscriptionPlanVersionResolutionProblem**(`externalSubscriptionId`, `reason`): `SubscriptionPlanVersionResolutionProblem`
...
> `readonly` **code**: `"billing/subscription-plan-version-resolution-failed"` = `"billing/subscription-plan-version-resolution-failed"`
