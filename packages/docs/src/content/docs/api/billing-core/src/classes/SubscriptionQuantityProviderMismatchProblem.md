...
next: false
prev: false
title: "SubscriptionQuantityProviderMismatchProblem"
---
...
> **new SubscriptionQuantityProviderMismatchProblem**(`externalSubscriptionId`, `expectedQuantity`, `actualQuantity`): `SubscriptionQuantityProviderMismatchProblem`
...
> `readonly` **code**: `"billing/subscription-quantity-provider-mismatch"` = `"billing/subscription-quantity-provider-mismatch"`
