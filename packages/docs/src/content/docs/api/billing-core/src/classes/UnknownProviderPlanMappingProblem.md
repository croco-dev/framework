...
next: false
prev: false
title: "UnknownProviderPlanMappingProblem"
---
...
> **new UnknownProviderPlanMappingProblem**(`provider`, `productId`, `priceIds`): `UnknownProviderPlanMappingProblem`
...
> `readonly` **code**: `"billing/unknown-provider-plan-mapping"` = `"billing/unknown-provider-plan-mapping"`
