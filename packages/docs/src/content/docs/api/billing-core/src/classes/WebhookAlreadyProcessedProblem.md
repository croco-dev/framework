...
next: false
prev: false
title: "WebhookAlreadyProcessedProblem"
---
...
> **new WebhookAlreadyProcessedProblem**(`eventId`): `WebhookAlreadyProcessedProblem`
...
> `readonly` **code**: `"billing/webhook-already-processed"` = `"billing/webhook-already-processed"`
