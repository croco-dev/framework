...
next: false
prev: false
title: "PlanVersionConflictProblem"
---
...
> **new PlanVersionConflictProblem**(`ref`, `reason`): `PlanVersionConflictProblem`
...
> `readonly` **code**: `"billing/plan-version-conflict"` = `"billing/plan-version-conflict"`
