...
next: false
prev: false
title: "InvalidPlanVersionDefinitionProblem"
---
...
> **new InvalidPlanVersionDefinitionProblem**(`reason`): `InvalidPlanVersionDefinitionProblem`
...
> `readonly` **code**: `"billing/invalid-plan-version-definition"` = `"billing/invalid-plan-version-definition"`
