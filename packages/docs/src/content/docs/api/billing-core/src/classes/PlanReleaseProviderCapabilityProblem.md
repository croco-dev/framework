...
next: false
prev: false
title: "PlanReleaseProviderCapabilityProblem"
---
...
> **new PlanReleaseProviderCapabilityProblem**(`ref`, `factCodes`): `PlanReleaseProviderCapabilityProblem`
...
> `readonly` **code**: `"billing/plan-release-provider-capability-failed"` = `"billing/plan-release-provider-capability-failed"`
