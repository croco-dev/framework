...
> **new PlanReleaseValidationFailedProblem**(`ref`, `diagnosticCodes`): `PlanReleaseValidationFailedProblem`
...
> `readonly` **code**: `"billing/plan-release-validation-failed"` = `"billing/plan-release-validation-failed"`
