...
next: false
prev: false
title: "InvalidPlanVersionRefProblem"
---
...
> **new InvalidPlanVersionRefProblem**(): `InvalidPlanVersionRefProblem`
...
> `readonly` **code**: `"billing/invalid-plan-version-ref"` = `"billing/invalid-plan-version-ref"`
