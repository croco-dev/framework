...
next: false
prev: false
title: "ProviderCapabilityUnavailableProblem"
---
...
> **new ProviderCapabilityUnavailableProblem**(`providerName`, `capability`): `ProviderCapabilityUnavailableProblem`
...
> `readonly` **code**: `"billing/provider-capability-unavailable"` = `"billing/provider-capability-unavailable"`
