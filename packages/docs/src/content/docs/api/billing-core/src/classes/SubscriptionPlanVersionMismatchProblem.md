...
next: false
prev: false
title: "SubscriptionPlanVersionMismatchProblem"
---
...
> **new SubscriptionPlanVersionMismatchProblem**(`subscriptionId`, `subscriptionPlanId`, `versionPlanId`): `SubscriptionPlanVersionMismatchProblem`
...
> `readonly` **category**: [`BusinessRuleViolation`](/api/problems-core/src/enumerations/problemcategory/#businessruleviolation) = `ProblemCategory.BusinessRuleViolation`
...
> `readonly` **code**: `"billing/subscription-plan-version-mismatch"` = `"billing/subscription-plan-version-mismatch"`
