...
> **new InvalidPlanReleaseTransitionProblem**(`ref`, `from`, `to`): `InvalidPlanReleaseTransitionProblem`
...
> `readonly` **code**: `"billing/invalid-plan-release-transition"` = `"billing/invalid-plan-release-transition"`
