...
next: false
prev: false
title: "SubscriptionPlanVersionMigrationProblem"
---
...
> **new SubscriptionPlanVersionMigrationProblem**(`externalSubscriptionId`, `reason`): `SubscriptionPlanVersionMigrationProblem`
...
> `readonly` **code**: `"billing/subscription-plan-version-migration-failed"` = `"billing/subscription-plan-version-migration-failed"`
