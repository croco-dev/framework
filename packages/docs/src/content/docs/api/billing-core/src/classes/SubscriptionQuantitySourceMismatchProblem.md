...
next: false
prev: false
title: "SubscriptionQuantitySourceMismatchProblem"
---
...
> **new SubscriptionQuantitySourceMismatchProblem**(`expectedPlanVersionRef`, `actualPlanVersionRef`, `expectedSeatQuota`, `actualSeatQuota`): `SubscriptionQuantitySourceMismatchProblem`

#### Parameters

##### expectedPlanVersionRef

`string`

##### actualPlanVersionRef
...
> `readonly` **code**: `"billing/subscription-quantity-source-mismatch"` = `"billing/subscription-quantity-source-mismatch"`
