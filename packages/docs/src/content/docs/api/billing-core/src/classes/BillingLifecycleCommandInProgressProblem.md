...
next: false
prev: false
title: "BillingLifecycleCommandInProgressProblem"
---
...
> **new BillingLifecycleCommandInProgressProblem**(`tenantId`, `idempotencyKey`): `BillingLifecycleCommandInProgressProblem`
...
> `readonly` **code**: `"billing/lifecycle-command-in-progress"` = `"billing/lifecycle-command-in-progress"`
