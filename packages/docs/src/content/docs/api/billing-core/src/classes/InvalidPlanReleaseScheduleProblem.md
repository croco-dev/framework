...
next: false
prev: false
title: "InvalidPlanReleaseScheduleProblem"
---
...
> **new InvalidPlanReleaseScheduleProblem**(`ref`, `reason`): `InvalidPlanReleaseScheduleProblem`
...
> `readonly` **code**: `"billing/invalid-plan-release-schedule"` = `"billing/invalid-plan-release-schedule"`
