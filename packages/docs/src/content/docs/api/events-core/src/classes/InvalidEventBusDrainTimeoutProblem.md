...
next: false
prev: false
title: "InvalidEventBusDrainTimeoutProblem"
---
...
> **new InvalidEventBusDrainTimeoutProblem**(`timeoutMs`): `InvalidEventBusDrainTimeoutProblem`
...
> `readonly` **code**: `"events-core/event-bus-drain-timeout-invalid"` = `"events-core/event-bus-drain-timeout-invalid"`
