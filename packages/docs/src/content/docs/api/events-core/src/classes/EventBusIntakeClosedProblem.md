...
next: false
prev: false
title: "EventBusIntakeClosedProblem"
---
...
> **new EventBusIntakeClosedProblem**(): `EventBusIntakeClosedProblem`
...
> `readonly` **code**: `"events-core/event-bus-intake-closed"` = `"events-core/event-bus-intake-closed"`
