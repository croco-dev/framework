...
next: false
prev: false
title: "EventAfterCommitPublishFailedProblem"
---
...
> **new EventAfterCommitPublishFailedProblem**(`eventName`, `cause`, `observerError?`): `EventAfterCommitPublishFailedProblem`
...
> `readonly` **code**: `"events-core/after-commit-publish-failed"` = `"events-core/after-commit-publish-failed"`
...
> `readonly` `optional` **observerError?**: `Error`
