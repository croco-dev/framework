...
next: false
prev: false
title: "GraphQLRequestHandlingFailedProblem"
---
...
> **new GraphQLRequestHandlingFailedProblem**(): `GraphQLRequestHandlingFailedProblem`
...
> `readonly` **code**: `"transports-graphql/request-handling-failed"` = `"transports-graphql/request-handling-failed"`
