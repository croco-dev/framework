...
next: false
prev: false
title: "GraphQLRequestBodyAbortedProblem"
---
...
> **new GraphQLRequestBodyAbortedProblem**(): `GraphQLRequestBodyAbortedProblem`
...
> `readonly` **code**: `"transports-graphql/request-body-aborted"` = `"transports-graphql/request-body-aborted"`
