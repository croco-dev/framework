...
next: false
prev: false
title: "GraphQLResolversNotConfiguredProblem"
---
...
> **new GraphQLResolversNotConfiguredProblem**(): `GraphQLResolversNotConfiguredProblem`
...
> `readonly` **code**: `"transports-graphql/resolvers-not-configured"` = `"transports-graphql/resolvers-not-configured"`
