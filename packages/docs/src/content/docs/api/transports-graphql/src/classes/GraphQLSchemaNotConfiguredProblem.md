...
next: false
prev: false
title: "GraphQLSchemaNotConfiguredProblem"
---
...
> **new GraphQLSchemaNotConfiguredProblem**(): `GraphQLSchemaNotConfiguredProblem`
...
> `readonly` **code**: `"transports-graphql/schema-not-configured"` = `"transports-graphql/schema-not-configured"`
