...
next: false
prev: false
title: "GraphQLServerNotInitializedProblem"
---
...
> **new GraphQLServerNotInitializedProblem**(`detail?`): `GraphQLServerNotInitializedProblem`

#### Parameters

##### detail?

`string` = `"Server not initialized. Call initialize() first."`
...
> `readonly` **code**: `"transports-graphql/server-not-initialized"` = `"transports-graphql/server-not-initialized"`
