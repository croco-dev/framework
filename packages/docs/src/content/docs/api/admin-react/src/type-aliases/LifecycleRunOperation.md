...
next: false
prev: false
title: "LifecycleRunOperation"
---

> **LifecycleRunOperation** = `object`
...
> `readonly` `optional` **links?**: `object`

#### operationsHref?

> `readonly` `optional` **operationsHref?**: `string`
...
> `readonly` **run**: [`LifecycleRunEvidence`](/api/admin-react/src/type-aliases/lifecyclerunevidence/)
