...
next: false
prev: false
title: "PlanReleaseOperationalState"
---

> **PlanReleaseOperationalState** = `object`
...
> `readonly` **snapshot**: [`PlanReleaseConsoleSnapshot`](/api/admin-react/src/type-aliases/planreleaseconsolesnapshot/)
