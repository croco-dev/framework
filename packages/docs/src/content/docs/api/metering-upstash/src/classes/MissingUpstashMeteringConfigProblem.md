...
next: false
prev: false
title: "MissingUpstashMeteringConfigProblem"
---
...
> **new MissingUpstashMeteringConfigProblem**(`configKey`): `MissingUpstashMeteringConfigProblem`
...
> `readonly` **code**: `"metering-upstash/missing-config"` = `"metering-upstash/missing-config"`
