...
next: false
prev: false
title: "UpstashMeteringUpstreamProblem"
---
...
> **new UpstashMeteringUpstreamProblem**(`operation`, `error`): `UpstashMeteringUpstreamProblem`
...
> `readonly` **code**: `"metering-upstash/upstream-failed"` = `"metering-upstash/upstream-failed"`
