...
next: false
prev: false
title: "ProductEventDefinitionProblem"
---
...
> **new ProductEventDefinitionProblem**(`reason`): `ProductEventDefinitionProblem`
...
> `readonly` **code**: `"analytics-core/product-event-definition-invalid"` = `"analytics-core/product-event-definition-invalid"`
