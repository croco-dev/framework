...
> **new FactHistoryProblem**(`code`, `message`, `cause?`): `FactHistoryProblem`

#### Parameters

##### code

[`FactHistoryProblemCode`](/api/analytics-core/src/type-aliases/facthistoryproblemcode/)
