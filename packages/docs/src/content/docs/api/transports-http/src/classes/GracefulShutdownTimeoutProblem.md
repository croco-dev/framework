...
next: false
prev: false
title: "GracefulShutdownTimeoutProblem"
---
...
> **new GracefulShutdownTimeoutProblem**(`options`): `GracefulShutdownTimeoutProblem`

#### Parameters

##### options

[`GracefulShutdownTimeoutProblemOptions`](/api/transports-http/src/type-aliases/gracefulshutdowntimeoutproblemoptions/)
