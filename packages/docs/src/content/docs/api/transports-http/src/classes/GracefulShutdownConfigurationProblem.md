...
next: false
prev: false
title: "GracefulShutdownConfigurationProblem"
---
...
> **new GracefulShutdownConfigurationProblem**(`options`): `GracefulShutdownConfigurationProblem`

#### Parameters

##### options

[`GracefulShutdownConfigurationProblemOptions`](/api/transports-http/src/type-aliases/gracefulshutdownconfigurationproblemoptions/)
