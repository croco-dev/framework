...
next: false
prev: false
title: "DevInspectorEndpointOptions"
---

> **DevInspectorEndpointOptions** = [`RuntimeInspectorOptions`](/api/framework-context/src/type-aliases/runtimeinspectoroptions/) & `object`
