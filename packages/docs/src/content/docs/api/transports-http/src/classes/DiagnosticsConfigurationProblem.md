...
next: false
prev: false
title: "DiagnosticsConfigurationProblem"
---
...
> **new DiagnosticsConfigurationProblem**(`options`): `DiagnosticsConfigurationProblem`

#### Parameters

##### options

[`DiagnosticsConfigurationProblemOptions`](/api/transports-http/src/type-aliases/diagnosticsconfigurationproblemoptions/)
