...
next: false
prev: false
title: "MonetizationSignalDefinitionProblem"
---
...
> **new MonetizationSignalDefinitionProblem**(`signalType`, `message`): `MonetizationSignalDefinitionProblem`

#### Parameters

##### signalType

[`MonetizationSignalType`](/api/lifecycle-core/src/type-aliases/monetizationsignaltype/)
