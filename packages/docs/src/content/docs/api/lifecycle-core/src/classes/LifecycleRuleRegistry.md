...
> **executeIfActive**\<`T`\>(`ruleId`, `version`, `claimId`, `execute`, `expiresAt?`): `Promise`\<[`LifecycleRuleExecutionResult`](/api/lifecycle-core/src/type-aliases/lifecycleruleexecutionresult/)\<`T`\>\>
