...
next: false
prev: false
title: "LifecycleRuleVersionConflictProblem"
---
...
> **new LifecycleRuleVersionConflictProblem**(`ruleId`, `expectedRevision`, `actualRevision`): `LifecycleRuleVersionConflictProblem`
