...
next: false
prev: false
title: "InvalidWebhookTimeoutProblem"
---
...
> **new InvalidWebhookTimeoutProblem**(`timeoutMs`): `InvalidWebhookTimeoutProblem`
...
> `readonly` **code**: `"lifecycle-core/webhook-timeout-invalid"` = `"lifecycle-core/webhook-timeout-invalid"`
