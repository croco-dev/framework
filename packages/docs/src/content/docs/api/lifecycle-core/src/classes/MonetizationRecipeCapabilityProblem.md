...
next: false
prev: false
title: "MonetizationRecipeCapabilityProblem"
---
...
> **new MonetizationRecipeCapabilityProblem**(`recipeId`, `missingCapabilities`): `MonetizationRecipeCapabilityProblem`

#### Parameters

##### recipeId

[`MonetizationRecipeId`](/api/lifecycle-core/src/type-aliases/monetizationrecipeid/)
