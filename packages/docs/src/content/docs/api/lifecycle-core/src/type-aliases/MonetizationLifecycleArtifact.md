...
next: false
prev: false
title: "MonetizationLifecycleArtifact"
---

> **MonetizationLifecycleArtifact** = `object`
...
> `readonly` **signals**: readonly [`MonetizationSignalDescriptor`](/api/lifecycle-core/src/type-aliases/monetizationsignaldescriptor/)[]
