...
next: false
prev: false
title: "BatchResultLengthMismatchProblem"
---
...
> **new BatchResultLengthMismatchProblem**(`expected`, `actual`): `BatchResultLengthMismatchProblem`
...
> `readonly` **code**: `"dataloader-core/batch-result-length-mismatch"` = `"dataloader-core/batch-result-length-mismatch"`
