...
> **new DuplicateBatchLoaderNameProblem**(`name`, `scope`, `dynamicScope`): `DuplicateBatchLoaderNameProblem`
...
> `readonly` **code**: `"dataloader-core/duplicate-loader-name"` = `"dataloader-core/duplicate-loader-name"`
