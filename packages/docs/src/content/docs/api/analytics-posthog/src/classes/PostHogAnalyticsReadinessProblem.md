...
next: false
prev: false
title: "PostHogAnalyticsReadinessProblem"
---
...
> **new PostHogAnalyticsReadinessProblem**(`options?`): `PostHogAnalyticsReadinessProblem`
...
> `readonly` **code**: `"analytics-posthog/readiness-failed"` = `"analytics-posthog/readiness-failed"`
