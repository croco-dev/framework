...
[`AnalyticsManager`](/api/analytics-core/src/classes/analyticsmanager/).[`captureValidatedEnvelope`](/api/analytics-core/src/classes/analyticsmanager/#capturevalidatedenvelope)
