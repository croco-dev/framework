...
next: false
prev: false
title: "PostHogAnalyticsFlushProblem"
---
...
> **new PostHogAnalyticsFlushProblem**(`cause?`): `PostHogAnalyticsFlushProblem`
...
> `readonly` **code**: `"analytics-posthog/flush-failed"` = `"analytics-posthog/flush-failed"`
