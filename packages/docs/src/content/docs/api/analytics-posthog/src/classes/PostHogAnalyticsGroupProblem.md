...
next: false
prev: false
title: "PostHogAnalyticsGroupProblem"
---
...
> **new PostHogAnalyticsGroupProblem**(`cause?`): `PostHogAnalyticsGroupProblem`
...
> `readonly` **code**: `"analytics-posthog/group-failed"` = `"analytics-posthog/group-failed"`
