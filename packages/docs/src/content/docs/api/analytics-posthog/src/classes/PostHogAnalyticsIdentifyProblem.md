...
next: false
prev: false
title: "PostHogAnalyticsIdentifyProblem"
---
...
> **new PostHogAnalyticsIdentifyProblem**(`cause?`): `PostHogAnalyticsIdentifyProblem`
...
> `readonly` **code**: `"analytics-posthog/identify-failed"` = `"analytics-posthog/identify-failed"`
