...
next: false
prev: false
title: "PostHogAnalyticsCaptureProblem"
---
...
> **new PostHogAnalyticsCaptureProblem**(`eventName`, `cause?`): `PostHogAnalyticsCaptureProblem`
...
> `readonly` **code**: `"analytics-posthog/capture-failed"` = `"analytics-posthog/capture-failed"`
