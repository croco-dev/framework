...
> **new InvalidHealthScoreInputProblem**(`input`, `value`, `expected`): `InvalidHealthScoreInputProblem`
...
> `readonly` **code**: `"customer-health-core/invalid-score-input"` = `"customer-health-core/invalid-score-input"`
