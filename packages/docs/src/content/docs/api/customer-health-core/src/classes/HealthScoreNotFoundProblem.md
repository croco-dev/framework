...
next: false
prev: false
title: "HealthScoreNotFoundProblem"
---
...
> **new HealthScoreNotFoundProblem**(`tenantId`): `HealthScoreNotFoundProblem`
...
> `readonly` **code**: `"HEALTH_SCORE_NOT_FOUND"` = `"HEALTH_SCORE_NOT_FOUND"`
