...
next: false
prev: false
title: "HealthEventIntentConflictProblem"
---
...
> **new HealthEventIntentConflictProblem**(`eventId`): `HealthEventIntentConflictProblem`
...
> `readonly` **code**: `"customer-health-core/event-intent-conflict"` = `"customer-health-core/event-intent-conflict"`
