...
next: false
prev: false
title: "HealthEventPublisherNotConfiguredProblem"
---
...
> **new HealthEventPublisherNotConfiguredProblem**(): `HealthEventPublisherNotConfiguredProblem`
...
> `readonly` **code**: `"customer-health-core/event-publisher-not-configured"` = `"customer-health-core/event-publisher-not-configured"`
