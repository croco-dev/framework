...
next: false
prev: false
title: "HealthTransitionPersistenceRetryExhaustedProblem"
---
...
> **new HealthTransitionPersistenceRetryExhaustedProblem**(`tenantId`, `attempts`): `HealthTransitionPersistenceRetryExhaustedProblem`
...
> `readonly` **code**: `"customer-health-core/transition-persistence-retry-exhausted"` = `"customer-health-core/transition-persistence-retry-exhausted"`
