...
next: false
prev: false
title: "DuplicateTxManagerRegistrationProblem"
---
...
> **new DuplicateTxManagerRegistrationProblem**(`key`): `DuplicateTxManagerRegistrationProblem`
...
> `readonly` **code**: `"tx-core/duplicate-tx-manager-registration"` = `"tx-core/duplicate-tx-manager-registration"`
