...
next: false
prev: false
title: "TransactionDecoratorProblem"
---
...
> **new TransactionDecoratorProblem**(): `TransactionDecoratorProblem`
...
> `readonly` **code**: `"tx-core/decorator-misuse"` = `"tx-core/decorator-misuse"`
