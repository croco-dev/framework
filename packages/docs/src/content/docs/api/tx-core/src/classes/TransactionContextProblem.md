...
next: false
prev: false
title: "TransactionContextProblem"
---
...
> **new TransactionContextProblem**(): `TransactionContextProblem`
...
> `readonly` **code**: `"tx-core/missing-transaction-context"` = `"tx-core/missing-transaction-context"`
