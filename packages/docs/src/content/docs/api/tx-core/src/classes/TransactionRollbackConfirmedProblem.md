...
next: false
prev: false
title: "TransactionRollbackConfirmedProblem"
---
...
> **new TransactionRollbackConfirmedProblem**(`cause`): `TransactionRollbackConfirmedProblem`
...
> `readonly` **code**: `"tx-core/transaction-rollback-confirmed"` = `"tx-core/transaction-rollback-confirmed"`
