...
next: false
prev: false
title: "TxManagerNotRegisteredError"
---
...
> **new TxManagerNotRegisteredError**(`key`): `TxManagerNotRegisteredError`
...
> `readonly` **code**: `"tx-core/manager-not-registered"` = `"tx-core/manager-not-registered"`
