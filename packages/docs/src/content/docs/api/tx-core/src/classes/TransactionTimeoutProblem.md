...
next: false
prev: false
title: "TransactionTimeoutProblem"
---
...
> **new TransactionTimeoutProblem**(`timeoutMs`, `cause?`): `TransactionTimeoutProblem`
...
> `readonly` **code**: `"tx-core/transaction-timeout"` = `"tx-core/transaction-timeout"`
