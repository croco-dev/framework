...
next: false
prev: false
title: "TransactionOutcomeUnknownProblem"
---
...
> **new TransactionOutcomeUnknownProblem**(`timeoutMs`, `cause`): `TransactionOutcomeUnknownProblem`
...
> `readonly` **code**: `"tx-core/transaction-outcome-unknown"` = `"tx-core/transaction-outcome-unknown"`
