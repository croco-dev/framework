...
next: false
prev: false
title: "AfterCommitOutcomeRequiredProblem"
---
...
> **new AfterCommitOutcomeRequiredProblem**(): `AfterCommitOutcomeRequiredProblem`
...
> `readonly` **code**: `"tx-core/after-commit-outcome-required"` = `"tx-core/after-commit-outcome-required"`
