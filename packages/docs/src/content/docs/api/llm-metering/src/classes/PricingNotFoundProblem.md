...
> **new PricingNotFoundProblem**(`provider`, `modelId`): `PricingNotFoundProblem`
...
> `readonly` **code**: `"llm-metering/pricing-not-found"` = `"llm-metering/pricing-not-found"`
