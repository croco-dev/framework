...
next: false
prev: false
title: "LlmCostBudgetExceededEvent"
---
...
> **new LlmCostBudgetExceededEvent**(`tenantId`, `currentCost`, `limit`, `period`): `LlmCostBudgetExceededEvent`
...
> `static` **eventName**: `string` = `"llm.cost_budget_exceeded"`
