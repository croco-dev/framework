...
> **new PostHogConfigProblem**(`detail`): `PostHogConfigProblem`
...
> `readonly` **code**: `"integrations-posthog/missing-config"` = `"integrations-posthog/missing-config"`
