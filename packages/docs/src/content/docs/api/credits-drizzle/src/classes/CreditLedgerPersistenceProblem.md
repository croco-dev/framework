...
next: false
prev: false
title: "CreditLedgerPersistenceProblem"
---
...
> **new CreditLedgerPersistenceProblem**(`operation`, `cause?`): `CreditLedgerPersistenceProblem`
...
> `readonly` **code**: `"credits-drizzle/persistence-failure"` = `"credits-drizzle/persistence-failure"`
