...
next: false
prev: false
title: "ConflictingPaginationProblem"
---
...
> **new ConflictingPaginationProblem**(): `ConflictingPaginationProblem`
...
> `readonly` **code**: `"CONFLICTING_PAGINATION"` = `"CONFLICTING_PAGINATION"`
