...
next: false
prev: false
title: "InvalidPaginationDirectionProblem"
---
...
> **new InvalidPaginationDirectionProblem**(`options`): `InvalidPaginationDirectionProblem`

#### Parameters

##### options

[`InvalidPaginationDirectionProblemOptions`](/api/pagination-core/src/type-aliases/invalidpaginationdirectionproblemoptions/)
...
> `readonly` **code**: `"INVALID_PAGINATION_DIRECTION"` = `"INVALID_PAGINATION_DIRECTION"`
