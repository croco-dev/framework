...
next: false
prev: false
title: "AmbiguousPaginationParameterProblem"
---
...
> **new AmbiguousPaginationParameterProblem**(`field`, `valueCount`): `AmbiguousPaginationParameterProblem`
...
> `readonly` **code**: `"AMBIGUOUS_PAGINATION_PARAMETER"` = `"AMBIGUOUS_PAGINATION_PARAMETER"`
