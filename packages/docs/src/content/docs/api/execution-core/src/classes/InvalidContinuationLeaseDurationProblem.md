...
next: false
prev: false
title: "InvalidContinuationLeaseDurationProblem"
---
...
> **new InvalidContinuationLeaseDurationProblem**(`options`): `InvalidContinuationLeaseDurationProblem`
...
> `readonly` **code**: [`INVALID_CONTINUATION_LEASE_DURATION`](/api/execution-core/src/enumerations/executionproblemcode/#invalid_continuation_lease_duration) = `ExecutionProblemCode.INVALID_CONTINUATION_LEASE_DURATION`
