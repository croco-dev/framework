...
next: false
prev: false
title: "ContainerResolutionProblem"
---
...
> **new ContainerResolutionProblem**(`detail`, `trace`, `reason`, `cause?`): `ContainerResolutionProblem`
...
[`ContainerResolutionFailureReason`](/api/framework-context/src/type-aliases/containerresolutionfailurereason/)
