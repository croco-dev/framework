...
next: false
prev: false
title: "OnShutdownDecoratorProblem"
---
...
> **new OnShutdownDecoratorProblem**(`reason`, `targetName`, `propertyKey?`, `existingPropertyKey?`): `OnShutdownDecoratorProblem`

#### Parameters

##### reason

[`OnShutdownDecoratorFailureReason`](/api/framework-context/src/type-aliases/onshutdowndecoratorfailurereason/)
...
> `readonly` **code**: `"framework-context/on-shutdown-decorator-invalid"` = `"framework-context/on-shutdown-decorator-invalid"`
...
> `readonly` **reason**: [`OnShutdownDecoratorFailureReason`](/api/framework-context/src/type-aliases/onshutdowndecoratorfailurereason/)
