...
next: false
prev: false
title: "InvalidShutdownTimeoutProblem"
---
...
> **new InvalidShutdownTimeoutProblem**(`timeoutMs`): `InvalidShutdownTimeoutProblem`
...
> `readonly` **code**: `"framework-context/shutdown-timeout-invalid"` = `"framework-context/shutdown-timeout-invalid"`
