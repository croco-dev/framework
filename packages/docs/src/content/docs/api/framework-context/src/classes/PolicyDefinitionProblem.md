...
> **new PolicyDefinitionProblem**(`detail`): `PolicyDefinitionProblem`
...
> `readonly` **code**: `"framework-context/policy-definition-invalid"` = `"framework-context/policy-definition-invalid"`
