...
> **new PolicyConflictProblem**(`detail`): `PolicyConflictProblem`
...
> `readonly` **code**: `"framework-context/policy-conflict"` = `"framework-context/policy-conflict"`
