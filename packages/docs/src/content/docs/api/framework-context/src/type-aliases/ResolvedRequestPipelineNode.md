...
next: false
prev: false
title: "ResolvedRequestPipelineNode"
---

> **ResolvedRequestPipelineNode** = `object`
...
> `readonly` **failurePropagation**: [`RequestPipelineFailurePropagation`](/api/framework-context/src/type-aliases/requestpipelinefailurepropagation/)
