...
> **new PipelineGraphProblem**(`detail`): `PipelineGraphProblem`
...
> `readonly` **code**: `"framework-context/pipeline-graph-invalid"` = `"framework-context/pipeline-graph-invalid"`
