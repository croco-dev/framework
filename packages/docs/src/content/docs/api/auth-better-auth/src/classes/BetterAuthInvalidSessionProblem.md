...
next: false
prev: false
title: "BetterAuthInvalidSessionProblem"
---
...
> **new BetterAuthInvalidSessionProblem**(): `BetterAuthInvalidSessionProblem`
...
> `readonly` **code**: `"auth-better-auth/invalid-session-payload"` = `"auth-better-auth/invalid-session-payload"`
