...
next: false
prev: false
title: "BetterAuthSessionNotFoundProblem"
---
...
> **new BetterAuthSessionNotFoundProblem**(`sessionId`): `BetterAuthSessionNotFoundProblem`
...
> `readonly` **code**: `"auth-better-auth/session-not-found"` = `"auth-better-auth/session-not-found"`
