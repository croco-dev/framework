...
next: false
prev: false
title: "InvalidWebhookSignatureProblem"
---
...
> **new InvalidWebhookSignatureProblem**(): `InvalidWebhookSignatureProblem`
...
> `readonly` **code**: `"auth-better-auth/invalid-webhook-signature"` = `"auth-better-auth/invalid-webhook-signature"`
