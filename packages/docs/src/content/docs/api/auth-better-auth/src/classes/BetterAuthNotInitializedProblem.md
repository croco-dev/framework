...
next: false
prev: false
title: "BetterAuthNotInitializedProblem"
---
...
> **new BetterAuthNotInitializedProblem**(): `BetterAuthNotInitializedProblem`
...
> `readonly` **code**: `"auth-better-auth/not-initialized"` = `"auth-better-auth/not-initialized"`
