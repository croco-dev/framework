...
next: false
prev: false
title: "BetterAuthSessionLookupProblem"
---
...
> **new BetterAuthSessionLookupProblem**(`cause`): `BetterAuthSessionLookupProblem`
...
> `readonly` **code**: `"auth-better-auth/session-lookup-failed"` = `"auth-better-auth/session-lookup-failed"`
