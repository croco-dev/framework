...
next: false
prev: false
title: "InvalidWebhookPayloadProblem"
---
...
> **new InvalidWebhookPayloadProblem**(): `InvalidWebhookPayloadProblem`
...
> `readonly` **code**: `"auth-better-auth/invalid-webhook-payload"` = `"auth-better-auth/invalid-webhook-payload"`
