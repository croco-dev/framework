...
next: false
prev: false
title: "BetterAuthUserNotFoundProblem"
---
...
> **new BetterAuthUserNotFoundProblem**(`userId`): `BetterAuthUserNotFoundProblem`
...
> `readonly` **code**: `"auth-better-auth/user-not-found"` = `"auth-better-auth/user-not-found"`
