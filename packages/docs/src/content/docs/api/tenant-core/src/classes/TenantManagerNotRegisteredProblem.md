...
next: false
prev: false
title: "TenantManagerNotRegisteredProblem"
---
...
> **new TenantManagerNotRegisteredProblem**(`key`): `TenantManagerNotRegisteredProblem`
...
`TenantManagerNotRegisteredProblem`
...
> `readonly` **code**: `"tenant-core/tenant-manager-not-registered"` = `"tenant-core/tenant-manager-not-registered"`
