...
next: false
prev: false
title: "DuplicateTenantManagerRegistrationProblem"
---
...
> **new DuplicateTenantManagerRegistrationProblem**(`key`): `DuplicateTenantManagerRegistrationProblem`
...
> `readonly` **code**: `"tenant-core/duplicate-tenant-manager-registration"` = `"tenant-core/duplicate-tenant-manager-registration"`
