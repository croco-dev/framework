...
next: false
prev: false
title: "TenantModelCompatibilityInput"
---

> **TenantModelCompatibilityInput** = `object`
...
> `readonly` **tenantModel**: [`TenantModelName`](/api/tenant-core/src/type-aliases/tenantmodelname/)
