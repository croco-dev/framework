...
next: false
prev: false
title: "DesktopWireSchemaProblem"
---
...
> **new DesktopWireSchemaProblem**(`diagnostics`): `DesktopWireSchemaProblem`

#### Parameters

##### diagnostics

readonly [`DesktopWireSchemaDiagnostic`](/api/protocols-desktop/src/type-aliases/desktopwireschemadiagnostic/)[]
...
> `readonly` **diagnostics**: readonly [`DesktopWireSchemaDiagnostic`](/api/protocols-desktop/src/type-aliases/desktopwireschemadiagnostic/)[]
