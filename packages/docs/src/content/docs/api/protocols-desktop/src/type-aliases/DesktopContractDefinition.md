...
`TGrants` *extends* [`DesktopGrantRecord`](/api/protocols-desktop/src/type-aliases/desktopgrantrecord/) = [`DesktopGrantRecord`](/api/protocols-desktop/src/type-aliases/desktopgrantrecord/)
