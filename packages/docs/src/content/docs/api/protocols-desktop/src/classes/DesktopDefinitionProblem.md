...
next: false
prev: false
title: "DesktopDefinitionProblem"
---
...
> **new DesktopDefinitionProblem**(`code`, `detail`): `DesktopDefinitionProblem`

#### Parameters

##### code

[`DesktopDefinitionProblemCode`](/api/protocols-desktop/src/type-aliases/desktopdefinitionproblemcode/)
