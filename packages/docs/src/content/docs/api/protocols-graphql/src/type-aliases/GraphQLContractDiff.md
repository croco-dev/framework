...
next: false
prev: false
title: "GraphQLContractDiff"
---

> **GraphQLContractDiff** = `object`
...
> `readonly` **nonBreakingChanges**: readonly [`GraphQLContractDiffChange`](/api/protocols-graphql/src/type-aliases/graphqlcontractdiffchange/)[]
