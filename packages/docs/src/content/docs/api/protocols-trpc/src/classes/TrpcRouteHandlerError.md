...
> **new TrpcRouteHandlerError**(`methodName`): `TrpcRouteHandlerError`
...
> `readonly` **code**: `"protocols-trpc/route-handler-not-callable"` = `"protocols-trpc/route-handler-not-callable"`
