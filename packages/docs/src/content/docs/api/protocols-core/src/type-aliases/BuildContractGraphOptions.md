...
next: false
prev: false
title: "BuildContractGraphOptions"
---

> **BuildContractGraphOptions** = `object`
...
> `readonly` `optional` **monetizationDiagnostics?**: readonly [`ContractDiagnostic`](/api/protocols-core/src/type-aliases/contractdiagnostic/)[]
