...
next: false
prev: false
title: "ContractGraphDiagnosticError"
---
...
> **new ContractGraphDiagnosticError**(`diagnostics`): `ContractGraphDiagnosticError`

#### Parameters

##### diagnostics

readonly [`ContractDiagnostic`](/api/protocols-core/src/type-aliases/contractdiagnostic/)[]
