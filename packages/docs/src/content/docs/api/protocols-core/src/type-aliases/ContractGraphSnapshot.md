...
next: false
prev: false
title: "ContractGraphSnapshot"
---

> **ContractGraphSnapshot** = `object`
...
> `readonly` **snapshotVersion**: [`ContractGraphSnapshotVersion`](/api/protocols-core/src/type-aliases/contractgraphsnapshotversion/)
