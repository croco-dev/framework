...
> **new R2ReadinessProblem**(`options?`): `R2ReadinessProblem`

#### Parameters

##### options?

`R2ReadinessProblemOptions` = `{}`
...
> `readonly` **code**: `"STORAGE_R2_READINESS_FAILED"` = `"STORAGE_R2_READINESS_FAILED"`
