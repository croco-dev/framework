...
> **new R2ObjectTooLargeProblem**(`key`, `maxBytes`): `R2ObjectTooLargeProblem`
...
> `readonly` **code**: `"STORAGE_R2_OBJECT_TOO_LARGE"` = `"STORAGE_R2_OBJECT_TOO_LARGE"`
