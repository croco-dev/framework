...
> **new MissingR2ConfigProblem**(`configKeys`): `MissingR2ConfigProblem`
...
> `readonly` **code**: `"STORAGE_R2_MISSING_CONFIG"` = `"STORAGE_R2_MISSING_CONFIG"`
