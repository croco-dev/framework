...
next: false
prev: false
title: "NotificationDefaultProviderConflictProblem"
---
...
> **new NotificationDefaultProviderConflictProblem**(`channel`, `existingProviderName`, `providerName`): `NotificationDefaultProviderConflictProblem`
