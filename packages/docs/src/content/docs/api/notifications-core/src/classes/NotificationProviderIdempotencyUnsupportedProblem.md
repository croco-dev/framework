...
next: false
prev: false
title: "NotificationProviderIdempotencyUnsupportedProblem"
---
...
> **new NotificationProviderIdempotencyUnsupportedProblem**(`providerName`, `channel`): `NotificationProviderIdempotencyUnsupportedProblem`
