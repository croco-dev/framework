...
next: false
prev: false
title: "NotificationPreferenceChannelMismatchProblem"
---
...
> **new NotificationPreferenceChannelMismatchProblem**(`requestedChannel`, `contextChannel`): `NotificationPreferenceChannelMismatchProblem`
