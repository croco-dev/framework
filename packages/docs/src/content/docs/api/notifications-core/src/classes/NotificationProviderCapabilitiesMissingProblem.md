...
next: false
prev: false
title: "NotificationProviderCapabilitiesMissingProblem"
---
...
> **new NotificationProviderCapabilitiesMissingProblem**(`providerName`): `NotificationProviderCapabilitiesMissingProblem`
