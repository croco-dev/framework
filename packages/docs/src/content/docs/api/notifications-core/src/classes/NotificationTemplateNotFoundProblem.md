...
next: false
prev: false
title: "NotificationTemplateNotFoundProblem"
---
...
> **new NotificationTemplateNotFoundProblem**(`request`): `NotificationTemplateNotFoundProblem`

#### Parameters

##### request

`NotificationTemplateRenderProblemRequest`
