...
next: false
prev: false
title: "NotificationProviderCapabilityNameMismatchProblem"
---
...
> **new NotificationProviderCapabilityNameMismatchProblem**(`providerName`, `capabilityProviderName`): `NotificationProviderCapabilityNameMismatchProblem`
