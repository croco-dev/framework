...
next: false
prev: false
title: "NotificationPreferenceDeniedProblem"
---
...
> **new NotificationPreferenceDeniedProblem**(`decision`): `NotificationPreferenceDeniedProblem`

#### Parameters

##### decision

`NotificationPreferenceProblemDecision`
