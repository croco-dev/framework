...
next: false
prev: false
title: "NotificationPreferenceContextRequiredProblem"
---
...
> **new NotificationPreferenceContextRequiredProblem**(`channel`): `NotificationPreferenceContextRequiredProblem`
