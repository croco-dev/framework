...
next: false
prev: false
title: "NotificationProviderAlreadyRegisteredProblem"
---
...
> **new NotificationProviderAlreadyRegisteredProblem**(`providerName`): `NotificationProviderAlreadyRegisteredProblem`
