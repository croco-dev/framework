...
next: false
prev: false
title: "NotificationProviderChannelMismatchProblem"
---
...
> **new NotificationProviderChannelMismatchProblem**(`providerName`, `requestedChannel`, `actualChannel`): `NotificationProviderChannelMismatchProblem`
