...
next: false
prev: false
title: "NotificationOutboxIdempotencyMismatchProblem"
---
...
> **new NotificationOutboxIdempotencyMismatchProblem**(`channel`): `NotificationOutboxIdempotencyMismatchProblem`
