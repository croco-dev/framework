...
next: false
prev: false
title: "NotificationTemplateVariablesInvalidProblem"
---
...
> **new NotificationTemplateVariablesInvalidProblem**(`template`, `issues`): `NotificationTemplateVariablesInvalidProblem`

#### Parameters

##### template

`NotificationTemplateProblemContract`
