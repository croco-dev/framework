...
next: false
prev: false
title: "NotificationTemplateAlreadyRegisteredProblem"
---
...
> **new NotificationTemplateAlreadyRegisteredProblem**(`template`): `NotificationTemplateAlreadyRegisteredProblem`

#### Parameters

##### template

`NotificationTemplateProblemRef`
