...
next: false
prev: false
title: "NotificationProviderCapabilityChannelMismatchProblem"
---
...
> **new NotificationProviderCapabilityChannelMismatchProblem**(`providerName`, `providerChannel`, `capabilityChannels`): `NotificationProviderCapabilityChannelMismatchProblem`
...
readonly [`NotificationChannel`](/api/notifications-core/src/enumerations/notificationchannel/)[]
