...
next: false
prev: false
title: "TestKernelResourceFidelityProblem"
---
...
> **new TestKernelResourceFidelityProblem**(`obligation`, `fidelity`): `TestKernelResourceFidelityProblem`

#### Parameters

##### obligation

[`TestKernelResourceObligation`](/api/testing/src/type-aliases/testkernelresourceobligation/)

##### fidelity

[`TestResourceFidelity`](/api/testing/src/type-aliases/testresourcefidelity/)
