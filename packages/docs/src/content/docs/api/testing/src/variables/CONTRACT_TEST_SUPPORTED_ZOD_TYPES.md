...
> `const` **CONTRACT\_TEST\_SUPPORTED\_ZOD\_TYPES**: readonly \[`"ZodString (min/max only)"`, `"ZodNumber (min/max/int only)"`, `"ZodBoolean"`, `"ZodLiteral"`, `"ZodEnum"`, `"ZodNativeEnum"`, `"ZodObject"`, `"ZodArray"`, `"ZodTuple"`, `"ZodUnion"`, `"ZodDiscriminatedUnion"`, `"ZodOptional"`, `"ZodNullable"`, `"ZodDefault"`\]
