...
next: false
prev: false
title: "TestEvidenceFidelityError"
---
...
> **new TestEvidenceFidelityError**(`record`, `field`, `expected`): `TestEvidenceFidelityError`
...
keyof [`TestEvidenceFidelity`](/api/testing/src/type-aliases/testevidencefidelity/)
...
> `readonly` **code**: `"CROCO_TEST_EVIDENCE_FIDELITY_UNSATISFIED"` = `"CROCO_TEST_EVIDENCE_FIDELITY_UNSATISFIED"`
