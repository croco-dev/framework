...
> **new ChangedTestPlanProblem**(`detail`, `cause?`): `ChangedTestPlanProblem`
...
> `readonly` **code**: `"CROCO_CHANGED_TEST_PLAN_INVALID"` = `"CROCO_CHANGED_TEST_PLAN_INVALID"`
