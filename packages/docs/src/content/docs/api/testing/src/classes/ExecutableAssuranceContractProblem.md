...
next: false
prev: false
title: "ExecutableAssuranceContractProblem"
---
...
> **new ExecutableAssuranceContractProblem**(`detail`): `ExecutableAssuranceContractProblem`
...
> `readonly` **code**: `"CROCO_EXECUTABLE_ASSURANCE_CONTRACT_INVALID"` = `"CROCO_EXECUTABLE_ASSURANCE_CONTRACT_INVALID"`
