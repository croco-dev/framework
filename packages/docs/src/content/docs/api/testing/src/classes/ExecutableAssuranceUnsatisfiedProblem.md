...
next: false
prev: false
title: "ExecutableAssuranceUnsatisfiedProblem"
---
...
> **new ExecutableAssuranceUnsatisfiedProblem**(`report`): `ExecutableAssuranceUnsatisfiedProblem`

#### Parameters

##### report

[`ExecutableAssuranceReport`](/api/testing/src/type-aliases/executableassurancereport/)
...
> `readonly` **code**: `"CROCO_EXECUTABLE_ASSURANCE_UNSATISFIED"` = `"CROCO_EXECUTABLE_ASSURANCE_UNSATISFIED"`
...
> `readonly` **report**: [`ExecutableAssuranceReport`](/api/testing/src/type-aliases/executableassurancereport/)
