...
next: false
prev: false
title: "DrizzleProviderConformanceOptions"
---

> **DrizzleProviderConformanceOptions** = `object`
...
> `readonly` **transaction**: [`DrizzleProviderTransactionConformance`](/api/testing/src/type-aliases/drizzleprovidertransactionconformance/)
