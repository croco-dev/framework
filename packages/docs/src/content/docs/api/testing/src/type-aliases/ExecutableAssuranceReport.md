...
> `readonly` **graphVersion**: _typeof_ [`EXECUTABLE_ASSURANCE_GRAPH_VERSION`](/api/testing/src/variables/executable_assurance_graph_version/)
...
> `readonly` **schemaVersion**: _typeof_ [`EXECUTABLE_ASSURANCE_REPORT_VERSION`](/api/testing/src/variables/executable_assurance_report_version/)
