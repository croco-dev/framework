...
next: false
prev: false
title: "ChangedTestSelectionBaseline"
---

> **ChangedTestSelectionBaseline** = `object`
...
> `readonly` **schemaVersion**: _typeof_ [`CHANGED_TEST_SELECTION_BASELINE_VERSION`](/api/testing/src/variables/changed_test_selection_baseline_version/)
