...
next: false
prev: false
title: "TestEvidenceContractError"
---
...
> **new TestEvidenceContractError**(`detail`, `cause?`): `TestEvidenceContractError`
...
> `readonly` **code**: `"CROCO_TEST_EVIDENCE_CONTRACT_INVALID"` = `"CROCO_TEST_EVIDENCE_CONTRACT_INVALID"`
