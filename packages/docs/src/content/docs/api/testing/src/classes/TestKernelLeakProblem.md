...
> **new TestKernelLeakProblem**(`leaks`, `replay`): `TestKernelLeakProblem`

#### Parameters

##### leaks

readonly [`TestKernelLeak`](/api/testing/src/type-aliases/testkernelleak/)[]
