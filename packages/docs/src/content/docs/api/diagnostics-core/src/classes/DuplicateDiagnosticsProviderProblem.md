...
next: false
prev: false
title: "DuplicateDiagnosticsProviderProblem"
---
...
> **new DuplicateDiagnosticsProviderProblem**(`providerName`): `DuplicateDiagnosticsProviderProblem`
...
> `readonly` **code**: `"diagnostics-core/duplicate-provider"` = `"diagnostics-core/duplicate-provider"`
