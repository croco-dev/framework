...
next: false
prev: false
title: "InvalidDiagnosticsTimeoutProblem"
---
...
> **new InvalidDiagnosticsTimeoutProblem**(`source`, `timeoutMs`): `InvalidDiagnosticsTimeoutProblem`

#### Parameters

##### source

[`DiagnosticsTimeoutSource`](/api/diagnostics-core/src/type-aliases/diagnosticstimeoutsource/)
...
> `readonly` **code**: `"diagnostics-core/invalid-timeout"` = `"diagnostics-core/invalid-timeout"`
