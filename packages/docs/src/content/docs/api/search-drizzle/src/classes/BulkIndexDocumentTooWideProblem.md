...
next: false
prev: false
title: "BulkIndexDocumentTooWideProblem"
---
...
> **new BulkIndexDocumentTooWideProblem**(`documentIndexes`, `parameterCount`, `maxParameterCount`): `BulkIndexDocumentTooWideProblem`
...
`BulkIndexDocumentTooWideProblem`
...
> `readonly` `static` **CODE**: `"search-drizzle/bulk-index-document-too-wide"` = `"search-drizzle/bulk-index-document-too-wide"`
