...
next: false
prev: false
title: "InvalidSearchQueryProblem"
---
...
> **new InvalidSearchQueryProblem**(`option`, `reason`): `InvalidSearchQueryProblem`
...
> `readonly` `static` **CODE**: `"search-drizzle/invalid-query"` = `"search-drizzle/invalid-query"`
