...
next: false
prev: false
title: "BulkIndexChunkFailedProblem"
---
...
> **new BulkIndexChunkFailedProblem**(`chunkIndex`, `failedDocumentIndexes`, `committedDocumentIndexes`, `transactional`, `cause`): `BulkIndexChunkFailedProblem`
...
> `readonly` `static` **CODE**: `"search-drizzle/bulk-index-chunk-failed"` = `"search-drizzle/bulk-index-chunk-failed"`
