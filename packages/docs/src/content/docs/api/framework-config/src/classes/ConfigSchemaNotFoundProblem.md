...
next: false
prev: false
title: "ConfigSchemaNotFoundProblem"
---
...
> **new ConfigSchemaNotFoundProblem**(`targetName`): `ConfigSchemaNotFoundProblem`
...
> `readonly` **code**: `"framework-config/config-schema-not-found"` = `"framework-config/config-schema-not-found"`
