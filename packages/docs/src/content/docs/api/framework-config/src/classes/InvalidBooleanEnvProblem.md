...
next: false
prev: false
title: "InvalidBooleanEnvProblem"
---
...
> **new InvalidBooleanEnvProblem**(`envName`, `value`): `InvalidBooleanEnvProblem`
...
> `readonly` **code**: `"framework-config/invalid-boolean-env"` = `"framework-config/invalid-boolean-env"`
