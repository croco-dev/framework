...
next: false
prev: false
title: "InvalidIdempotencySnapshotProblem"
---
...
> **new InvalidIdempotencySnapshotProblem**(`options`): `InvalidIdempotencySnapshotProblem`

#### Parameters

##### options

[`InvalidIdempotencySnapshotProblemOptions`](/api/idempotency-core/src/type-aliases/invalididempotencysnapshotproblemoptions/)
