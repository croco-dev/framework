...
next: false
prev: false
title: "DuplicateIdPrefixProblem"
---
...
> **new DuplicateIdPrefixProblem**(`prefix`, `firstKey`, `duplicateKey`): `DuplicateIdPrefixProblem`
...
> `readonly` **code**: `"gid-core/duplicate-prefix"` = `"gid-core/duplicate-prefix"`
