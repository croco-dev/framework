...
next: false
prev: false
title: "AiPricingNotFoundProblem"
---
...
> **new AiPricingNotFoundProblem**(`provider`, `modelId`): `AiPricingNotFoundProblem`
...
> `readonly` **code**: `"ai-usage/pricing-not-found"` = `"ai-usage/pricing-not-found"`
