...
next: false
prev: false
title: "CloudflareImagesValidationProblem"
---
...
> **new CloudflareImagesValidationProblem**(`context`, `detail?`): `CloudflareImagesValidationProblem`

#### Parameters

##### context

[`CloudflareImagesErrorContext`](/api/storage-cloudflare/src/type-aliases/cloudflareimageserrorcontext/)

##### detail?

`string` = `"Cloudflare Images request validation failed"`
