...
next: false
prev: false
title: "CloudflareImagesMissingConfigProblem"
---
...
> **new CloudflareImagesMissingConfigProblem**(`configKey`, `operation?`): `CloudflareImagesMissingConfigProblem`

#### Parameters

##### configKey

[`CloudflareImagesConfigKey`](/api/storage-cloudflare/src/type-aliases/cloudflareimagesconfigkey/)
