...
Defined in: [packages/metering-core/src/libs/problems/InvalidMeterProblem.ts:3](https://github.com/croco-dev/framework/blob/dfdc13c04d1ec41944df1d6a5c5701779b83d710/packages/metering-core/src/libs/problems/InvalidMeterProblem.ts#L3)

등록되지 않은 Meter를 사용할 때 발생하는 문제 타입입니다.

## Description

존재하지 않는 Meter를 참조하려는 경우 발생합니다. HTTP 404 Not Found 응답에 해당합니다.
...
Defined in: [packages/metering-core/src/libs/problems/InvalidMeterProblem.ts:4](https://github.com/croco-dev/framework/blob/dfdc13c04d1ec41944df1d6a5c5701779b83d710/packages/metering-core/src/libs/problems/InvalidMeterProblem.ts#L4)
