...
next: false
prev: false
title: "BillableUsageJournalRequiredProblem"
---
...
> **new BillableUsageJournalRequiredProblem**(`meterId`): `BillableUsageJournalRequiredProblem`
...
`BillableUsageJournalRequiredProblem`
