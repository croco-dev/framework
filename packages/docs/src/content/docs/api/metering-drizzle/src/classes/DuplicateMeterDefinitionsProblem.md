...
next: false
prev: false
title: "DuplicateMeterDefinitionsProblem"
---
...
> **new DuplicateMeterDefinitionsProblem**(`duplicates`): `DuplicateMeterDefinitionsProblem`
...
`DuplicateMeterDefinitionsProblem`
