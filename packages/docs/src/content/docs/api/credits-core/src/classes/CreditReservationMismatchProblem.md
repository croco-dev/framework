...
next: false
prev: false
title: "CreditReservationMismatchProblem"
---
...
> **new CreditReservationMismatchProblem**(`reservationId`, `reason`): `CreditReservationMismatchProblem`
...
> `readonly` **code**: `"credits-core/reservation-mismatch"` = `"credits-core/reservation-mismatch"`
