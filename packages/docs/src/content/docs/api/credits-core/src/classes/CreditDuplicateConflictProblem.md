...
next: false
prev: false
title: "CreditDuplicateConflictProblem"
---
...
> **new CreditDuplicateConflictProblem**(`idempotencyKey`): `CreditDuplicateConflictProblem`
...
> `readonly` **code**: `"credits-core/duplicate-conflict"` = `"credits-core/duplicate-conflict"`
