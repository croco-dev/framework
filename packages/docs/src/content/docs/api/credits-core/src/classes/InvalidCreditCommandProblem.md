...
next: false
prev: false
title: "InvalidCreditCommandProblem"
---
...
> **new InvalidCreditCommandProblem**(`reason`): `InvalidCreditCommandProblem`
...
> `readonly` **code**: `"credits-core/invalid-command"` = `"credits-core/invalid-command"`
