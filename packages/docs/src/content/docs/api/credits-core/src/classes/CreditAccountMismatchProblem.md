...
next: false
prev: false
title: "CreditAccountMismatchProblem"
---
...
> **new CreditAccountMismatchProblem**(`resourceId`, `expectedAccountId`, `actualAccountId`): `CreditAccountMismatchProblem`
...
> `readonly` **code**: `"credits-core/account-mismatch"` = `"credits-core/account-mismatch"`
