...
next: false
prev: false
title: "InsufficientCreditsProblem"
---
...
> **new InsufficientCreditsProblem**(`accountId`, `requested`, `available`): `InsufficientCreditsProblem`
...
> `readonly` **code**: `"credits-core/insufficient-credits"` = `"credits-core/insufficient-credits"`
