...
next: false
prev: false
title: "CreditAccountNotFoundProblem"
---
...
> **new CreditAccountNotFoundProblem**(`accountId`): `CreditAccountNotFoundProblem`
...
> `readonly` **code**: `"credits-core/account-not-found"` = `"credits-core/account-not-found"`
