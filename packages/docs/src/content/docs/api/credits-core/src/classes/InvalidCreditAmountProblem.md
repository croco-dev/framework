...
next: false
prev: false
title: "InvalidCreditAmountProblem"
---
...
> **new InvalidCreditAmountProblem**(`reason`): `InvalidCreditAmountProblem`
...
> `readonly` **code**: `"credits-core/invalid-amount"` = `"credits-core/invalid-amount"`
