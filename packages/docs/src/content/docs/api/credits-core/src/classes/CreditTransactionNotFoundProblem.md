...
next: false
prev: false
title: "CreditTransactionNotFoundProblem"
---
...
> **new CreditTransactionNotFoundProblem**(`transactionId`): `CreditTransactionNotFoundProblem`
...
> `readonly` **code**: `"credits-core/transaction-not-found"` = `"credits-core/transaction-not-found"`
