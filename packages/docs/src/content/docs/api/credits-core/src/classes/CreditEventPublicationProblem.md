...
next: false
prev: false
title: "CreditEventPublicationProblem"
---
...
> **new CreditEventPublicationProblem**(`idempotencyKey`, `cause`): `CreditEventPublicationProblem`
...
> `readonly` **code**: `"credits-core/event-publication-failed"` = `"credits-core/event-publication-failed"`
