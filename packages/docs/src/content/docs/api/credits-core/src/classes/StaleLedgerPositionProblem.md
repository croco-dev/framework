...
next: false
prev: false
title: "StaleLedgerPositionProblem"
---
...
> **new StaleLedgerPositionProblem**(`accountId`, `expected`, `actual`): `StaleLedgerPositionProblem`
...
> `readonly` **code**: `"credits-core/stale-ledger-position"` = `"credits-core/stale-ledger-position"`
