...
next: false
prev: false
title: "CreditRefundMismatchProblem"
---
...
> **new CreditRefundMismatchProblem**(`transactionId`, `reason`): `CreditRefundMismatchProblem`
...
> `readonly` **code**: `"credits-core/refund-mismatch"` = `"credits-core/refund-mismatch"`
