...
next: false
prev: false
title: "EntitlementMissingPlanProblem"
---
...
> **new EntitlementMissingPlanProblem**(`feature`, `tenantId`, `decisionId?`): `EntitlementMissingPlanProblem`
...
> `readonly` **code**: `"ENTITLEMENT_MISSING_PLAN"` = `"ENTITLEMENT_MISSING_PLAN"`
