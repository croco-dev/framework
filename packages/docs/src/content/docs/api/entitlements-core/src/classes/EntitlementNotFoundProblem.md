...
next: false
prev: false
title: "EntitlementNotFoundProblem"
---
...
> **new EntitlementNotFoundProblem**(`feature`): `EntitlementNotFoundProblem`
...
> `readonly` **code**: `"ENTITLEMENT_NOT_FOUND"` = `"ENTITLEMENT_NOT_FOUND"`
