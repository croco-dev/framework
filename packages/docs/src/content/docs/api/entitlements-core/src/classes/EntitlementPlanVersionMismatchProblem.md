...
next: false
prev: false
title: "EntitlementPlanVersionMismatchProblem"
---
...
> **new EntitlementPlanVersionMismatchProblem**(`ref`, `expectedPlanId`, `actualPlanId`): `EntitlementPlanVersionMismatchProblem`
...
> `readonly` **code**: `"entitlements-core/plan-version-mismatch"` = `"entitlements-core/plan-version-mismatch"`
