...
next: false
prev: false
title: "EntitlementProviderUnavailableProblem"
---
...
> **new EntitlementProviderUnavailableProblem**(`feature`, `cause?`, `decisionId?`): `EntitlementProviderUnavailableProblem`
...
> `readonly` **code**: `"ENTITLEMENT_PROVIDER_UNAVAILABLE"` = `"ENTITLEMENT_PROVIDER_UNAVAILABLE"`
