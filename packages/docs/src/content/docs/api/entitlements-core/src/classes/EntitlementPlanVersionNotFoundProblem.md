...
next: false
prev: false
title: "EntitlementPlanVersionNotFoundProblem"
---
...
> **new EntitlementPlanVersionNotFoundProblem**(`ref`): `EntitlementPlanVersionNotFoundProblem`
...
> `readonly` **code**: `"entitlements-core/plan-version-not-found"` = `"entitlements-core/plan-version-not-found"`
