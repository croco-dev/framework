...
next: false
prev: false
title: "EntitlementRequirementProblem"
---
...
> **new EntitlementRequirementProblem**(`detail`): `EntitlementRequirementProblem`
...
> `readonly` **code**: `"ENTITLEMENT_REQUIREMENT_INVALID"` = `"ENTITLEMENT_REQUIREMENT_INVALID"`
