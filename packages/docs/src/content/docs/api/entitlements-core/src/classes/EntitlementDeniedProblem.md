...
next: false
prev: false
title: "EntitlementDeniedProblem"
---
...
> **new EntitlementDeniedProblem**(`feature`, `reason?`, `decisionId?`): `EntitlementDeniedProblem`
...
> `readonly` **code**: `"ENTITLEMENT_DENIED"` = `"ENTITLEMENT_DENIED"`
