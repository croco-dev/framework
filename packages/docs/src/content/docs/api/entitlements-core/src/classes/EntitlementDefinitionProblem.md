...
next: false
prev: false
title: "EntitlementDefinitionProblem"
---
...
> **new EntitlementDefinitionProblem**(`detail`): `EntitlementDefinitionProblem`
...
> `readonly` **code**: `"entitlements-core/definition-invalid"` = `"entitlements-core/definition-invalid"`
