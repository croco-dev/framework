...
next: false
prev: false
title: "EntitlementInactiveSubscriptionProblem"
---
...
> **new EntitlementInactiveSubscriptionProblem**(`feature`, `tenantId`, `decisionId?`): `EntitlementInactiveSubscriptionProblem`
...
> `readonly` **code**: `"ENTITLEMENT_INACTIVE_SUBSCRIPTION"` = `"ENTITLEMENT_INACTIVE_SUBSCRIPTION"`
