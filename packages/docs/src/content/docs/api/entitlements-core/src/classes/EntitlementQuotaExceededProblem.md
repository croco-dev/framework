...
next: false
prev: false
title: "EntitlementQuotaExceededProblem"
---
...
> **new EntitlementQuotaExceededProblem**(`feature`, `usage?`, `quota?`, `decisionId?`): `EntitlementQuotaExceededProblem`
...
> `readonly` **code**: `"ENTITLEMENT_QUOTA_EXCEEDED"` = `"ENTITLEMENT_QUOTA_EXCEEDED"`
