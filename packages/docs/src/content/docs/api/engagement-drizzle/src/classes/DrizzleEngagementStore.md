...
> **new DrizzleEngagementStore**(`db`, `txManager`, `clock?`): `DrizzleEngagementStore`

#### Parameters

##### db

[`DrizzleEngagementClient`](/api/engagement-drizzle/src/type-aliases/drizzleengagementclient/)

##### txManager

[`DrizzleEngagementTxManager`](/api/engagement-drizzle/src/type-aliases/drizzleengagementtxmanager/)
