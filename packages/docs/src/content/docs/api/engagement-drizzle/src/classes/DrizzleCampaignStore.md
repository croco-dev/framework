...
> **new DrizzleCampaignStore**(`db`, `txManager`): `DrizzleCampaignStore`

#### Parameters

##### db

[`DrizzleCampaignClient`](/api/engagement-drizzle/src/type-aliases/drizzlecampaignclient/)

##### txManager

[`DrizzleCampaignTxManager`](/api/engagement-drizzle/src/type-aliases/drizzlecampaigntxmanager/)
