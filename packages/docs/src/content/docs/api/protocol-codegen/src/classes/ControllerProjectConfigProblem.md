...
next: false
prev: false
title: "ControllerProjectConfigProblem"
---
...
> **new ControllerProjectConfigProblem**(`reason`, `tsconfigPath`, `detail`): `ControllerProjectConfigProblem`

#### Parameters

##### reason

`ControllerProjectConfigReason`
