...
next: false
prev: false
title: "BlockedDuringImpersonationProblem"
---
...
> **new BlockedDuringImpersonationProblem**(`action`): `BlockedDuringImpersonationProblem`
...
> `readonly` **code**: `"BLOCKED_DURING_IMPERSONATION"` = `"BLOCKED_DURING_IMPERSONATION"`
