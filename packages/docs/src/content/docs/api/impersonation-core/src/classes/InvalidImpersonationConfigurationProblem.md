...
> **new InvalidImpersonationConfigurationProblem**(`options`): `InvalidImpersonationConfigurationProblem`

#### Parameters

##### options

[`InvalidImpersonationConfigurationProblemOptions`](/api/impersonation-core/src/type-aliases/invalidimpersonationconfigurationproblemoptions/)
...
> `readonly` **code**: `"IMPERSONATION_CONFIGURATION_INVALID"` = `"IMPERSONATION_CONFIGURATION_INVALID"`
...
> `readonly` **constraint**: [`ImpersonationConfigurationConstraint`](/api/impersonation-core/src/type-aliases/impersonationconfigurationconstraint/)
...
> `readonly` **field**: [`ImpersonationConfigurationField`](/api/impersonation-core/src/type-aliases/impersonationconfigurationfield/)
