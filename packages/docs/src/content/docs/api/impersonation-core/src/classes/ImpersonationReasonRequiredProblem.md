...
next: false
prev: false
title: "ImpersonationReasonRequiredProblem"
---
...
> **new ImpersonationReasonRequiredProblem**(): `ImpersonationReasonRequiredProblem`
...
> `readonly` **code**: `"IMPERSONATION_REASON_REQUIRED"` = `"IMPERSONATION_REASON_REQUIRED"`
