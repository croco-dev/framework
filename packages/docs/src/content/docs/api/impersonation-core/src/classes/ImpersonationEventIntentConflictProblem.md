...
next: false
prev: false
title: "ImpersonationEventIntentConflictProblem"
---
...
> **new ImpersonationEventIntentConflictProblem**(`eventId`): `ImpersonationEventIntentConflictProblem`
...
> `readonly` **code**: `"impersonation-core/event-intent-conflict"` = `"impersonation-core/event-intent-conflict"`
