...
next: false
prev: false
title: "ImpersonationSessionNotFoundProblem"
---
...
> **new ImpersonationSessionNotFoundProblem**(`sessionId`): `ImpersonationSessionNotFoundProblem`
...
> `readonly` **code**: `"IMPERSONATION_SESSION_NOT_FOUND"` = `"IMPERSONATION_SESSION_NOT_FOUND"`
