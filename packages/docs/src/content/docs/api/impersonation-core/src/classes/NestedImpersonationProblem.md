...
next: false
prev: false
title: "NestedImpersonationProblem"
---
...
> **new NestedImpersonationProblem**(): `NestedImpersonationProblem`
...
> `readonly` **code**: `"NESTED_IMPERSONATION_NOT_ALLOWED"` = `"NESTED_IMPERSONATION_NOT_ALLOWED"`
