...
next: false
prev: false
title: "ImpersonationIdentityConflictProblem"
---
...
> **new ImpersonationIdentityConflictProblem**(): `ImpersonationIdentityConflictProblem`
...
> `readonly` **code**: `"IMPERSONATION_IDENTITY_CONFLICT"` = `"IMPERSONATION_IDENTITY_CONFLICT"`
