...
> **new ImpersonationSessionActorMismatchProblem**(): `ImpersonationSessionActorMismatchProblem`
...
> `readonly` **code**: `"IMPERSONATION_SESSION_ACTOR_MISMATCH"` = `"IMPERSONATION_SESSION_ACTOR_MISMATCH"`
