...
next: false
prev: false
title: "SelfImpersonationProblem"
---
...
> **new SelfImpersonationProblem**(): `SelfImpersonationProblem`
...
> `readonly` **code**: `"SELF_IMPERSONATION_NOT_ALLOWED"` = `"SELF_IMPERSONATION_NOT_ALLOWED"`
