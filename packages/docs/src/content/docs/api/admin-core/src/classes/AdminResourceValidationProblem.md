...
next: false
prev: false
title: "AdminResourceValidationProblem"
---
...
> **new AdminResourceValidationProblem**(`report`): `AdminResourceValidationProblem`

#### Parameters

##### report

[`AdminResourceValidationReport`](/api/admin-core/src/type-aliases/adminresourcevalidationreport/)
