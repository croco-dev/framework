...
next: false
prev: false
title: "WebhookOperationsActionValidationProblem"
---
...
> **new WebhookOperationsActionValidationProblem**(`field`): `WebhookOperationsActionValidationProblem`

#### Parameters

##### field

keyof [`WebhookOperationsWriteEvidence`](/api/admin-core/src/type-aliases/webhookoperationswriteevidence/)
