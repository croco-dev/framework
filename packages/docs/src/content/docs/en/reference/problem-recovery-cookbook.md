...
This cookbook documents 517 public Croco Problem codes. The deterministic JSON registry is generated at `docs/problem-code-registry.json`, and generated client union types are emitted at `packages/problems-core/src/generated/problem-code-registry.ts`.
...
- `packages/billing-core/src/libs/problems/BillingProblems.ts:126:3` (problem-class)
...
- `packages/billing-core/src/libs/problems/BillingProblems.ts:104:3` (problem-class)
...
- `packages/billing-core/src/libs/problems/BillingProblems.ts:112:3` (problem-class)
