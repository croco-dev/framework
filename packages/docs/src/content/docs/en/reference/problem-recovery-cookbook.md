...
This cookbook documents 785 public Croco Problem codes. The deterministic JSON registry is generated at `docs/problem-code-registry.json`, and generated client union types are emitted at `packages/problems-core/src/generated/problem-code-registry.ts`.
...
- `packages/events-core/src/libs/problems/EventsProblems.ts:174:1` (problem-class)
...
- `packages/triggers-qstash/src/libs/QStashTriggerHandler.ts:424:13` (problem-metadata)
...
- `packages/triggers-qstash/src/libs/QStashTriggerHandler.ts:252:13` (problem-factory)
...
- `packages/triggers-qstash/src/libs/QStashTriggerHandler.ts:414:15` (problem-metadata)
