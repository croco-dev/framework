...
This cookbook documents 456 public Croco Problem codes. The deterministic JSON registry is generated at `docs/problem-code-registry.json`, and generated client union types are emitted at `packages/problems-core/src/generated/problem-code-registry.ts`.
...
| [`metering/invalid-meter-definition`](#metering-invalid-meter-definition)                                                             | ValidationError       |    422 | not-retryable | public        | active    |       1 |
...
<a id="metering-invalid-meter-definition"></a>
...
- `packages/metering-core/src/libs/problems/InvalidMeterDefinitionProblem.ts:5:5` (problem-constructor)
...
- `packages/metering-core/src/libs/problems/InvalidUsageEnvelopeProblem.ts:5:5` (problem-constructor)
