...
This cookbook documents 762 public Croco Problem codes. The deterministic JSON registry is generated at `docs/problem-code-registry.json`, and generated client union types are emitted at `packages/problems-core/src/generated/problem-code-registry.ts`.
...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:125:1` (problem-class)
...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:89:1` (problem-class)
...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:116:1` (problem-class)
...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:134:1` (problem-class)
...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:98:1` (problem-class)
...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:107:1` (problem-class)
