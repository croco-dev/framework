...
This cookbook documents 551 public Croco Problem codes. The deterministic JSON registry is generated at `docs/problem-code-registry.json`, and generated client union types are emitted at `packages/problems-core/src/generated/problem-code-registry.ts`.
...
- `packages/admin-core/src/libs/CreditOperations.ts:284:5` (problem-constructor)
