...
This cookbook documents 511 public Croco Problem codes. The deterministic JSON registry is generated at `docs/problem-code-registry.json`, and generated client union types are emitted at `packages/problems-core/src/generated/problem-code-registry.ts`.
...
- `packages/events-tx/src/libs/problems/EventsTxProblems.ts:28:3` (problem-class)
...
- `packages/events-tx/src/libs/problems/EventsTxProblems.ts:89:3` (problem-class)
...
- `packages/events-tx/src/libs/problems/EventsTxProblems.ts:74:3` (problem-class)
...
- `packages/events-tx/src/libs/problems/EventsTxProblems.ts:65:3` (problem-class)
...
- `packages/events-tx/src/libs/problems/EventsTxProblems.ts:48:3` (problem-class)
...
- `packages/testing/src/libs/testing.ts:183:5` (problem-constructor)
