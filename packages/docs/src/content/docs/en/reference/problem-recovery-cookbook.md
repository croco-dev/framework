...
This cookbook documents 409 public Croco Problem codes. The deterministic JSON registry is generated at `docs/problem-code-registry.json`, and generated client union types are emitted at `packages/problems-core/src/generated/problem-code-registry.ts`.
...
| [`outbox-core/failure-metadata-missing`](#outbox-core-failure-metadata-missing)                                                       | InternalServerError   |    500 | conditional   | operator-only | active    |       1 |
| [`outbox-core/unit-of-work-context-invalid`](#outbox-core-unit-of-work-context-invalid)                                               | InternalServerError   |    500 | conditional   | operator-only | active    |       1 |
...
- `packages/outbox-core/src/libs/problems/OutboxProblems.ts:79:5` (problem-constructor)
...
- `packages/outbox-core/src/libs/problems/OutboxProblems.ts:93:5` (problem-constructor)
