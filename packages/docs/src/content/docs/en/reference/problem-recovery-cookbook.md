...
This cookbook documents 500 public Croco Problem codes. The deterministic JSON registry is generated at `docs/problem-code-registry.json`, and generated client union types are emitted at `packages/problems-core/src/generated/problem-code-registry.ts`.
...
- `packages/framework-context/src/libs/Container.ts:59:10` (problem-factory)
...
- `packages/framework-context/src/libs/Container.ts:1635:13` (problem-factory)
...
- `packages/framework-context/src/libs/problems/ShutdownProblems.ts:84:3` (problem-class)
...
- `packages/framework-context/src/libs/problems/ShutdownProblems.ts:99:3` (problem-class)
...
- `packages/testing/src/libs/TestKernel.ts:66:5` (problem-constructor)
