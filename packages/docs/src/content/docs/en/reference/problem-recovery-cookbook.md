...
This cookbook documents 751 public Croco Problem codes. The deterministic JSON registry is generated at `docs/problem-code-registry.json`, and generated client union types are emitted at `packages/problems-core/src/generated/problem-code-registry.ts`.
...
- `packages/events-inmemory/src/libs/problems/EventsInmemoryProblems.ts:105:1` (problem-class)
...
- `packages/events-inmemory/src/libs/problems/EventsInmemoryProblems.ts:121:1` (problem-class)
...
- `packages/events-inmemory/src/libs/InmemoryEventBus.ts:90:1` (problem-class)
...
- `packages/events-inmemory/src/libs/InmemoryEventBus.ts:73:1` (problem-class)
