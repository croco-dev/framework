...
This cookbook documents 649 public Croco Problem codes. The deterministic JSON registry is generated at `docs/problem-code-registry.json`, and generated client union types are emitted at `packages/problems-core/src/generated/problem-code-registry.ts`.
...
- `packages/impersonation-core/src/libs/problems/ImpersonationProblems.ts:19:3` (problem-class)
...
- `packages/impersonation-core/src/libs/problems/ImpersonationProblems.ts:39:3` (problem-class)
