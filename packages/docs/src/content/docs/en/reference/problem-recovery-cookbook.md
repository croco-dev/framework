...
This cookbook documents 418 public Croco Problem codes. The deterministic JSON registry is generated at `docs/problem-code-registry.json`, and generated client union types are emitted at `packages/problems-core/src/generated/problem-code-registry.ts`.
...
| [`transports-graphql/request-body-too-large`](#transports-graphql-request-body-too-large)                                             | BadRequest            |    400 | not-retryable | public        | active    |       1 |
