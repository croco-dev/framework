...
This cookbook documents 755 public Croco Problem codes. The deterministic JSON registry is generated at `docs/problem-code-registry.json`, and generated client union types are emitted at `packages/problems-core/src/generated/problem-code-registry.ts`.
...
- `packages/events-inmemory/src/libs/InmemoryEventBus.ts:100:1` (problem-class)
...
- `packages/events-inmemory/src/libs/InmemoryEventBus.ts:83:1` (problem-class)
