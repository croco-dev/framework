...
This cookbook documents 412 public Croco Problem codes. The deterministic JSON registry is generated at `docs/problem-code-registry.json`, and generated client union types are emitted at `packages/problems-core/src/generated/problem-code-registry.ts`.
...
| [`transports-http/middleware-next-called-multiple-times`](#transports-http-middleware-next-called-multiple-times)                     | InternalServerError   |    500 | conditional   | operator-only | active    |       1 |
