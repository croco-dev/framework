...
This cookbook documents 811 public Croco Problem codes. The deterministic JSON registry is generated at `docs/problem-code-registry.json`, and generated client union types are emitted at `packages/problems-core/src/generated/problem-code-registry.ts`.
...
| [`admin-core/event-catalog-validation-failed`](#admin-core-event-catalog-validation-failed)                                           | ValidationError       |    422 | not-retryable | public        | active     |       1 |
| [`admin-core/fact-history-input`](#admin-core-fact-history-input)                                                                     | ValidationError       |    422 | not-retryable | public        | active     |       1 |
...
| [`ai-saas/model-not-found`](#ai-saas-model-not-found)                                                                                 | NotFound              |    404 | not-retryable | public        | deprecated |       0 |
...
| [`ai-usage/cost-limit-exceeded`](#ai-usage-cost-limit-exceeded)                                                                       | Forbidden             |    403 | not-retryable | safe-message  | active     |       1 |
| [`ai-usage/pricing-not-found`](#ai-usage-pricing-not-found)                                                                           | NotFound              |    404 | not-retryable | public        | active     |       1 |
...
| [`analytics-core/product-event-definition-invalid`](#analytics-core-product-event-definition-invalid)                                 | ValidationError       |    422 | not-retryable | public        | active     |       1 |
...
| [`analytics/fact-history/deleted`](#analytics-fact-history-deleted)                                                                   | Gone                  |    410 | not-retryable | public        | active     |       1 |
| [`analytics/fact-history/denied`](#analytics-fact-history-denied)                                                                     | Forbidden             |    403 | not-retryable | safe-message  | active     |       1 |
| [`analytics/fact-history/history-limit`](#analytics-fact-history-history-limit)                                                       | ValidationError       |    422 | not-retryable | public        | active     |       1 |
| [`analytics/fact-history/invalid-input`](#analytics-fact-history-invalid-input)                                                       | ValidationError       |    422 | not-retryable | public        | active     |       1 |
| [`analytics/fact-history/invalid-value`](#analytics-fact-history-invalid-value)                                                       | ValidationError       |    422 | not-retryable | public        | active     |       1 |
| [`analytics/fact-history/persistence-failed`](#analytics-fact-history-persistence-failed)                                             | InternalServerError   |    500 | conditional   | operator-only | active     |       1 |
...
| [`dataloader-core/duplicate-loader-name`](#dataloader-core-duplicate-loader-name)                                                     | InternalServerError   |    500 | not-retryable | operator-only | active     |       1 |
| [`desktop-codegen/invalid-contract-graph`](#desktop-codegen-invalid-contract-graph)                                                   | ValidationError       |    422 | not-retryable | public        | deprecated |       0 |
| [`desktop-codegen/invalid-renderer-contract-graph`](#desktop-codegen-invalid-renderer-contract-graph)                                 | ValidationError       |    422 | not-retryable | public        | deprecated |       0 |
...
| [`EMBEDDING_ERROR`](#embedding-error)                                                                                                 | InternalServerError   |    500 | conditional   | operator-only | deprecated |       0 |
...
| [`events-core/after-commit-publish-failed`](#events-core-after-commit-publish-failed)                                                 | InternalServerError   |    500 | conditional   | operator-only | active     |       1 |
...
| [`events-core/handler-resolver-required`](#events-core-handler-resolver-required)                                                     | InternalServerError   |    500 | conditional   | operator-only | active     |       1 |
| [`events-core/transaction-context-unavailable`](#events-core-transaction-context-unavailable)                                         | InternalServerError   |    500 | conditional   | operator-only | deprecated |       0 |
...
| [`events-inmemory/missing-handler-resolver`](#events-inmemory-missing-handler-resolver)                                               | InternalServerError   |    500 | conditional   | operator-only | active     |       1 |
...
| [`framework-context/generated-di-graph-invalid`](#framework-context-generated-di-graph-invalid)                                       | BadRequest            |    400 | not-retryable | public        | active     |       1 |
| [`framework-context/generated-di-graph-version-mismatch`](#framework-context-generated-di-graph-version-mismatch)                     | BadRequest            |    400 | not-retryable | public        | active     |       1 |
| [`framework-context/generated-di-provider-conflict`](#framework-context-generated-di-provider-conflict)                               | Conflict              |    409 | conditional   | safe-message  | active     |       1 |
| [`framework-context/generated-di-token-identity-conflict`](#framework-context-generated-di-token-identity-conflict)                   | Conflict              |    409 | conditional   | safe-message  | active     |       1 |
...
| [`framework-context/request-scope-disposal-failed`](#framework-context-request-scope-disposal-failed)                                 | InternalServerError   |    500 | conditional   | operator-only | active     |       1 |
| [`framework-context/request-scope-missing`](#framework-context-request-scope-missing)                                                 | InternalServerError   |    500 | conditional   | operator-only | active     |       1 |
...
| [`GENERATION_ERROR`](#generation-error)                                                                                               | InternalServerError   |    500 | conditional   | operator-only | deprecated |       0 |
...
| [`LLM_PROVIDER_NOT_FOUND`](#llm-provider-not-found)                                                                                   | NotFound              |    404 | not-retryable | public        | deprecated |       0 |
| [`LLM_SERVICE_ERROR`](#llm-service-error)                                                                                             | InternalServerError   |    500 | conditional   | operator-only | deprecated |       0 |
| [`llm-core/completion-event-publication-failed`](#llm-core-completion-event-publication-failed)                                       | Conflict              |    409 | not-retryable | operator-only | deprecated |       0 |
| [`llm-core/invalid-llm-prompt`](#llm-core-invalid-llm-prompt)                                                                         | BadRequest            |    400 | not-retryable | public        | deprecated |       0 |
| [`llm-core/invalid-llm-response`](#llm-core-invalid-llm-response)                                                                     | InternalServerError   |    500 | conditional   | operator-only | deprecated |       0 |
| [`llm-core/llm-service-not-initialized`](#llm-core-llm-service-not-initialized)                                                       | InternalServerError   |    500 | conditional   | operator-only | deprecated |       0 |
| [`llm-core/operation-aborted`](#llm-core-operation-aborted)                                                                           | BadRequest            |    400 | not-retryable | public        | deprecated |       0 |
| [`llm-core/rate-limit-exceeded`](#llm-core-rate-limit-exceeded)                                                                       | TooManyRequests       |    429 | retryable     | safe-message  | deprecated |       0 |
| [`llm-metering/cost-limit-exceeded`](#llm-metering-cost-limit-exceeded)                                                               | Forbidden             |    403 | not-retryable | safe-message  | deprecated |       0 |
| [`llm-metering/pricing-not-found`](#llm-metering-pricing-not-found)                                                                   | NotFound              |    404 | not-retryable | public        | deprecated |       0 |
| [`llm-metering/pricing-registry-conflict`](#llm-metering-pricing-registry-conflict)                                                   | Conflict              |    409 | conditional   | safe-message  | deprecated |       0 |
| [`llm-metering/quota-exceeded`](#llm-metering-quota-exceeded)                                                                         | Forbidden             |    403 | not-retryable | safe-message  | deprecated |       0 |
| [`llm-metering/record-failed`](#llm-metering-record-failed)                                                                           | InternalServerError   |    500 | conditional   | operator-only | deprecated |       0 |
| [`llm-metering/service-required`](#llm-metering-service-required)                                                                     | InternalServerError   |    500 | not-retryable | operator-only | deprecated |       0 |
| [`llm-openai/aborted`](#llm-openai-aborted)                                                                                           | BadRequest            |    400 | not-retryable | public        | deprecated |       0 |
| [`llm-openai/authentication-failed`](#llm-openai-authentication-failed)                                                               | Unauthorized          |    401 | not-retryable | safe-message  | deprecated |       0 |
| [`llm-openai/invalid-response`](#llm-openai-invalid-response)                                                                         | InternalServerError   |    500 | conditional   | operator-only | deprecated |       0 |
| [`llm-openai/missing-config`](#llm-openai-missing-config)                                                                             | InternalServerError   |    500 | conditional   | operator-only | deprecated |       0 |
| [`llm-openai/rate-limited`](#llm-openai-rate-limited)                                                                                 | TooManyRequests       |    429 | retryable     | safe-message  | deprecated |       0 |
| [`llm-openai/retryable-upstream`](#llm-openai-retryable-upstream)                                                                     | InternalServerError   |    500 | conditional   | operator-only | deprecated |       0 |
| [`llm-openai/terminal-upstream`](#llm-openai-terminal-upstream)                                                                       | InternalServerError   |    500 | conditional   | operator-only | deprecated |       0 |
| [`llm-openai/validation-failed`](#llm-openai-validation-failed)                                                                       | BadRequest            |    400 | not-retryable | public        | deprecated |       0 |
...
| [`migration-runner/invalid-target`](#migration-runner-invalid-target)                                                                 | BadRequest            |    400 | not-retryable | public        | active     |       1 |
...
| [`MODEL_NOT_FOUND`](#model-not-found)                                                                                                 | NotFound              |    404 | not-retryable | public        | deprecated |       0 |
...
| [`onboarding/definition-invalid`](#onboarding-definition-invalid)                                                                     | ValidationError       |    422 | not-retryable | public        | active     |       1 |
...
| [`rpc-codegen/path-param-input-unsupported`](#rpc-codegen-path-param-input-unsupported)                                               | ValidationError       |    422 | not-retryable | public        | active     |       1 |
...
| [`STRUCTURED_OUTPUT_ERROR`](#structured-output-error)                                                                                 | InternalServerError   |    500 | conditional   | operator-only | deprecated |       0 |
...
| [`TOKEN_LIMIT_EXCEEDED`](#token-limit-exceeded)                                                                                       | BadRequest            |    400 | not-retryable | public        | deprecated |       0 |
| [`TOOL_EXECUTION_ERROR`](#tool-execution-error)                                                                                       | InternalServerError   |    500 | conditional   | operator-only | deprecated |       0 |
...
| [`transports-http/unsupported-media-type`](#transports-http-unsupported-media-type)                                                   | UnsupportedMediaType  |    415 | not-retryable | public        | active     |       1 |
...
- `packages/access-core/src/libs/guards/AccessGuard.ts:23:5` (problem-constructor)
...
<a id="admin-core-event-catalog-validation-failed"></a>
...
- `packages/admin-core/src/libs/EventCatalog.ts:183:5` (problem-constructor)

<a id="admin-core-fact-history-input"></a>
...
- `packages/admin-core/src/libs/FactHistoryValidation.ts:80:5` (problem-constructor)
...
- Reason: The framework-owned LLM abstraction or its generated example contract was retired.
- Migration note: Remove branches for this code and handle vendor SDK failures explicitly at the application call boundary.
- No replacement reason: The retired generic LLM capability has no framework-level equivalent.
...
- `packages/create-croco-app/templates/ai-saas/apps/api-server/src/aiProblems.ts:43:1` (problem-class)
...
<a id="ai-usage-cost-limit-exceeded"></a>
...
- `packages/ai-usage/src/libs/problems/AiUsageProblems.ts:45:5` (problem-constructor)

<a id="ai-usage-pricing-not-found"></a>

## `ai-usage/pricing-not-found`
...
- `packages/ai-usage/src/libs/problems/AiUsageProblems.ts:61:1` (problem-class)

<a id="ai-usage-pricing-registry-conflict"></a>
...
- `packages/ai-usage/src/libs/problems/AiUsageProblems.ts:75:5` (problem-constructor)

<a id="ai-usage-quota-exceeded"></a>
...
- `packages/ai-usage/src/libs/problems/AiUsageProblems.ts:24:5` (problem-constructor)

<a id="ai-usage-record-failed"></a>
...
- Redaction policy: `operator-only`
- Lifecycle: `active`
- Cause: The provider completed billable work, but the application could not record its usage in the metering ledger.
- User action: Hand the opaque failure reference to an operator; do not invoke the provider again for the same request.
- Operator action: Recover the metering dependency, then replay the preserved usage receipt with the same idempotency key without repeating the provider call.
- Telemetry: `croco.problem.error` (error) with `problem.code`, `problem.category`, `problem.status`
...
<a id="analytics-core-product-event-definition-invalid"></a>

## `analytics-core/product-event-definition-invalid`
...
- `packages/analytics-core/src/libs/ProductEvent.ts:152:1` (problem-class)
...
<a id="analytics-fact-history-deleted"></a>

## `analytics/fact-history/deleted`
...
- `packages/analytics-core/src/libs/FactHistory.ts:126:12` (problem-metadata)

<a id="analytics-fact-history-denied"></a>

## `analytics/fact-history/denied`
...
- `packages/analytics-core/src/libs/FactHistory.ts:125:11` (problem-metadata)

<a id="analytics-fact-history-history-limit"></a>

## `analytics/fact-history/history-limit`
...
- `packages/analytics-core/src/libs/FactHistory.ts:127:20` (problem-metadata)

<a id="analytics-fact-history-invalid-input"></a>

## `analytics/fact-history/invalid-input`
...
- `packages/analytics-core/src/libs/FactHistory.ts:105:20` (problem-metadata)

<a id="analytics-fact-history-invalid-value"></a>

## `analytics/fact-history/invalid-value`
...
- `packages/analytics-core/src/libs/FactHistory.ts:109:20` (problem-metadata)

<a id="analytics-fact-history-persistence-failed"></a>

## `analytics/fact-history/persistence-failed`
...
- `packages/analytics-core/src/libs/FactHistory.ts:131:25` (problem-metadata)

<a id="analytics-fact-history-projection-conflict"></a>

## `analytics/fact-history/projection-conflict`
...
- `packages/analytics-core/src/libs/FactHistory.ts:117:26` (problem-metadata)

<a id="analytics-fact-history-revision-conflict"></a>

## `analytics/fact-history/revision-conflict`
...
- `packages/analytics-core/src/libs/FactHistory.ts:121:24` (problem-metadata)

<a id="analytics-fact-history-source-conflict"></a>

## `analytics/fact-history/source-conflict`
...
<a id="dataloader-core-duplicate-loader-name"></a>

## `dataloader-core/duplicate-loader-name`
...
- Reason: Croco desktop contracts and code generation were removed from the supported product scope.
- Migration note: See docs/release/problem-code-migrations.md#desktop-support-removal.
- No replacement reason: Croco does not provide a replacement desktop bridge or silently map desktop contracts to web scaffolds.
...
- `packages/events-core/src/libs/problems/EventsProblems.ts:158:1` (problem-class)

<a id="events-core-after-commit-publish-failed"></a>

## `events-core/after-commit-publish-failed`
...
- `packages/events-core/src/libs/problems/EventsProblems.ts:173:1` (problem-class)
...
- `packages/events-core/src/libs/problems/EventsProblems.ts:147:1` (problem-class)
...
- `packages/events-core/src/libs/problems/EventsProblems.ts:117:1` (problem-class)
...
- `packages/events-core/src/libs/problems/EventsProblems.ts:132:1` (problem-class)
...
- `packages/events-core/src/libs/problems/EventsProblems.ts:54:1` (problem-class)
...
- `packages/events-core/src/libs/problems/EventsProblems.ts:30:1` (problem-class)
...
- `packages/events-core/src/libs/problems/EventsProblems.ts:21:1` (problem-class)
...
- `packages/events-core/src/libs/problems/EventsProblems.ts:84:1` (problem-class)

<a id="events-core-handler-resolver-required"></a>

## `events-core/handler-resolver-required`
...
- `packages/events-core/src/libs/problems/EventsProblems.ts:5:1` (problem-class)
...
- Reason: After-commit publication no longer resolves a transaction context through a process-global container.
- Migration note: See docs/release/problem-code-migrations.md#explicit-event-transaction-context.
- Replacement code: `events-core/after-commit-requires-active-transaction`
...
- `packages/events-inmemory/src/libs/problems/EventsInmemoryProblems.ts:174:1` (problem-class)
...
- `packages/events-inmemory/src/libs/problems/EventsInmemoryProblems.ts:190:1` (problem-class)
...
- `packages/events-inmemory/src/libs/problems/EventsInmemoryProblems.ts:122:1` (problem-class)
...
- `packages/events-inmemory/src/libs/problems/EventsInmemoryProblems.ts:32:1` (problem-class)
...
- `packages/events-inmemory/src/libs/problems/EventsInmemoryProblems.ts:56:1` (problem-class)
...
- `packages/events-inmemory/src/libs/problems/EventsInmemoryProblems.ts:77:1` (problem-class)
...
- `packages/events-inmemory/src/libs/problems/EventsInmemoryProblems.ts:155:1` (problem-class)

<a id="events-inmemory-missing-handler-resolver"></a>

## `events-inmemory/missing-handler-resolver`
...
- `packages/events-inmemory/src/libs/problems/EventsInmemoryProblems.ts:4:1` (problem-class)
...
- `packages/events-inmemory/src/libs/InmemoryEventBus.ts:105:1` (problem-class)
...
- `packages/events-inmemory/src/libs/InmemoryEventBus.ts:88:1` (problem-class)
...
<a id="framework-context-request-scope-disposal-failed"></a>
...
- `packages/framework-context/src/libs/Context.ts:106:28` (problem-factory)

<a id="framework-context-request-scope-missing"></a>
...
- `packages/framework-context/src/libs/Context.ts:28:11` (problem-factory)
...
- Reason: The framework-owned LLM abstraction was removed in favor of application-owned SDK calls and SDK-independent usage ingestion.
- Migration note: Branch on ai-usage/cost-limit-exceeded after migrating usage handling to @croco/ai-usage.
- Replacement code: `ai-usage/cost-limit-exceeded`
...
- Reason: The framework-owned LLM abstraction was removed in favor of application-owned SDK calls and SDK-independent usage ingestion.
- Migration note: Branch on ai-usage/pricing-not-found after migrating usage handling to @croco/ai-usage.
- Replacement code: `ai-usage/pricing-not-found`
...
- Reason: The framework-owned LLM abstraction was removed in favor of application-owned SDK calls and SDK-independent usage ingestion.
- Migration note: Branch on ai-usage/pricing-registry-conflict after migrating usage handling to @croco/ai-usage.
- Replacement code: `ai-usage/pricing-registry-conflict`
...
- Reason: The framework-owned LLM abstraction was removed in favor of application-owned SDK calls and SDK-independent usage ingestion.
- Migration note: Branch on ai-usage/quota-exceeded after migrating usage handling to @croco/ai-usage.
- Replacement code: `ai-usage/quota-exceeded`
...
- Reason: The framework-owned LLM abstraction was removed in favor of application-owned SDK calls and SDK-independent usage ingestion.
- Migration note: Branch on ai-usage/record-failed after migrating usage handling to @croco/ai-usage.
- Replacement code: `ai-usage/record-failed`
...
- `packages/metering-drizzle/src/libs/DrizzleMeterRepository.ts:237:13` (problem-factory)
...
- `packages/metering-drizzle/src/libs/problems/DuplicateMeterDefinitionsProblem.ts:22:5` (problem-constructor)

<a id="metering-drizzle-invalid-meter-definition"></a>
...
- `packages/metering-drizzle/src/migrations/migrationSupport.ts:50:10` (problem-factory)
...
- `packages/metrics-core/src/libs/problems/MetricsProblems.ts:75:1` (problem-class)

<a id="metrics-core-invalid-user-carrying-capacity-metric"></a>
...
- `packages/metrics-core/src/libs/problems/MetricsProblems.ts:95:1` (problem-class)
...
- `packages/metrics-core/src/libs/problems/MetricsProblems.ts:65:1` (problem-class)
...
<a id="migration-runner-invalid-target"></a>

## `migration-runner/invalid-target`
...
- Redaction policy: `public`
- Lifecycle: `active`
- Cause: A rollback target is not a 14-digit migration id or does not appear in the applied checkpoint history.
- User action: Use the full 14-digit id of an applied migration; inspect migrate status to confirm the target before retrying.
- Operator action: Check migrate status and the checkpoint history, then rerun down with an applied migration id after confirming the intended rollback range.
- Telemetry: `croco.problem.error` (error) with `problem.code`, `problem.category`, `problem.status`

Sources:

- `packages/migration-runner/src/libs/problems/InvalidMigrationTargetProblem.ts:5:1` (problem-class)
...
- `packages/onboarding-core/src/libs/problems/OnboardingProblems.ts:69:1` (problem-class)

<a id="onboarding-definition-invalid"></a>

## `onboarding/definition-invalid`
...
- `packages/onboarding-core/src/libs/problems/OnboardingProblems.ts:28:1` (problem-class)
...
- `packages/onboarding-core/src/libs/problems/OnboardingProblems.ts:99:1` (problem-class)
...
- `packages/onboarding-core/src/libs/problems/OnboardingProblems.ts:84:1` (problem-class)
...
- `packages/onboarding-core/src/libs/problems/OnboardingProblems.ts:58:1` (problem-class)
...
- `packages/problems-core/src/libs/ProblemRegistry.ts:212:5` (problem-constructor)
...
<a id="rpc-codegen-path-param-input-unsupported"></a>

## `rpc-codegen/path-param-input-unsupported`
...
- `packages/tasks-core/src/libs/problems/TasksProblems.ts:26:5` (problem-constructor)

<a id="tasks-core-execution-already-settled"></a>
...
- `packages/tasks-core/src/libs/problems/TasksProblems.ts:110:5` (problem-constructor)
...
- `packages/tasks-core/src/libs/problems/TasksProblems.ts:80:5` (problem-constructor)
...
- `packages/tasks-core/src/libs/problems/TasksProblems.ts:16:1` (problem-class)
...
- `packages/tasks-core/src/libs/problems/TasksProblems.ts:42:5` (problem-constructor)
...
- `packages/tasks-core/src/libs/problems/TasksProblems.ts:59:5` (problem-constructor)
...
- `packages/testing/src/libs/testing.ts:192:5` (problem-constructor)
...
- `packages/testing/src/libs/testing.ts:170:5` (problem-constructor)
...
- `packages/transports-http/src/libs/ParamResolver.ts:149:13` (problem-factory)
...
- `packages/transports-http/src/libs/ParamResolver.ts:186:13` (problem-factory)
...
- `packages/transports-http/src/libs/CrocoRouteRegistrar.ts:40:49` (problem-metadata)
...
- `packages/transports-http/src/libs/ParamResolver.ts:397:13` (problem-factory)
...
## `transports-http/unsupported-media-type`
...
- User action: Send the request body with a supported Content-Type and retry.
- Operator action: Confirm the route media-type contract and request Content-Type header.
- Telemetry: `croco.problem.info` (info) with `problem.code`, `problem.category`, `problem.status`

Sources:

- `packages/transports-http/src/libs/ParamResolver.ts:224:13` (problem-factory)
