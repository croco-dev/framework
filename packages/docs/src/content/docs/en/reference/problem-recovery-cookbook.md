...
This cookbook documents 446 public Croco Problem codes. The deterministic JSON registry is generated at `docs/problem-code-registry.json`, and generated client union types are emitted at `packages/problems-core/src/generated/problem-code-registry.ts`.
...
- `packages/framework-module/src/problems.ts:20:5` (problem-constructor)
...
- `packages/framework-module/src/problems.ts:10:5` (problem-constructor)
...
- `packages/framework-module/src/problems.ts:86:5` (problem-constructor)
...
- `packages/framework-module/src/problems.ts:102:5` (problem-constructor)
...
- `packages/idempotency-core/src/libs/problems/IdempotencyProblems.ts:64:11` (problem-metadata)
...
- `packages/idempotency-core/src/libs/problems/IdempotencyProblems.ts:97:11` (problem-metadata)
