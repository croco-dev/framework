...
This cookbook documents 502 public Croco Problem codes. The deterministic JSON registry is generated at `docs/problem-code-registry.json`, and generated client union types are emitted at `packages/problems-core/src/generated/problem-code-registry.ts`.
...
- `packages/testing/src/libs/TestKernel.ts:92:5` (problem-constructor)
...
- `packages/testing/src/libs/TestKernel.ts:112:5` (problem-constructor)
...
- `packages/testing/src/libs/TestKernel.ts:79:5` (problem-constructor)
