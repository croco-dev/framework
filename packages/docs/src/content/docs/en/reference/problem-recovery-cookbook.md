...
This cookbook documents 766 public Croco Problem codes. The deterministic JSON registry is generated at `docs/problem-code-registry.json`, and generated client union types are emitted at `packages/problems-core/src/generated/problem-code-registry.ts`.
...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:80:1` (problem-class)
...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:93:1` (problem-class)
...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:147:1` (problem-class)
...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:54:1` (problem-class)
...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:102:1` (problem-class)
...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:67:1` (problem-class)
...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:111:1` (problem-class)
...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:138:1` (problem-class)
...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:156:1` (problem-class)
...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:120:1` (problem-class)
...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:129:1` (problem-class)
...
- `packages/transports-http/src/libs/ParamResolver.ts:274:13` (problem-factory)
...
- `packages/workflow-core/src/libs/problems/WorkflowProblems.ts:202:5` (problem-constructor)
