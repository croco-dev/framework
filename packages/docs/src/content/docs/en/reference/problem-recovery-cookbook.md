...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:42:1` (problem-class)
...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:96:1` (problem-class)
...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:51:1` (problem-class)
...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:60:1` (problem-class)
...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:105:1` (problem-class)
...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:69:1` (problem-class)
...
- `packages/create-croco-app/templates/saas/apps/api-server/src/problems.ts:78:1` (problem-class)
