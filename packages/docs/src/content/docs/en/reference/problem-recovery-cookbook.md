...
| [`rpc-codegen/invalid-contract-monetization-declaration`](#rpc-codegen-invalid-contract-monetization-declaration)                     | ValidationError       |    422 | not-retryable | public        | active    |       1 |
...
- `packages/protocols-core/src/libs/ContractGraph.ts:147:5` (problem-constructor)
...
- `packages/rpc-codegen/src/libs/loadRoutes.ts:85:5` (problem-constructor)
...
<a id="rpc-codegen-invalid-contract-monetization-declaration"></a>
...
- `packages/rpc-codegen/src/libs/loadRoutes.ts:46:5` (problem-constructor)
