...
This cookbook documents 405 public Croco Problem codes. The deterministic JSON registry is generated at `docs/problem-code-registry.json`, and generated client union types are emitted at `packages/problems-core/src/generated/problem-code-registry.ts`.
...
| [`transports-http/security-middleware-validation`](#transports-http-security-middleware-validation)                                   | InternalServerError   |    500 | conditional   | operator-only | active    |       1 |
