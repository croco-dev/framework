...
This cookbook documents 598 public Croco Problem codes. The deterministic JSON registry is generated at `docs/problem-code-registry.json`, and generated client union types are emitted at `packages/problems-core/src/generated/problem-code-registry.ts`.
...
| [`TELEMETRY_SIGNAL_UNSUPPORTED`](#telemetry-signal-unsupported)                                                                       | BadRequest            |    400 | not-retryable | public        | deprecated |       1 |
...
- `packages/testing/src/libs/test-evidence.mts:159:5` (problem-constructor)
...
- `packages/testing/src/libs/test-evidence.mts:173:5` (problem-constructor)
...
- `packages/telemetry-sdk-node/src/libs/problems/TelemetryProblems.ts:114:3` (problem-class)
...
- Migration note: Stop branching on TELEMETRY_SIGNAL_UNSUPPORTED and remove metrics or logs options from TelemetryConfig consumers.
- No replacement reason: The trace-only runtime has no unsupported signal configuration path to replace this code.
