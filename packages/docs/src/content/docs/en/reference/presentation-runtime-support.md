...
| -------------------------------------- | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `@croco/frontend-react`                | Promoted to beta. | Package tests cover optional, required, and parsed page data access through `PageDataProvider`. Generated `meta-vite-web` and `meta-vite-fullstack-workers` smoke assert required page data, browser hydration, visible hydration mismatch failure, page data/meta flow, and preserved hydration roots. |
