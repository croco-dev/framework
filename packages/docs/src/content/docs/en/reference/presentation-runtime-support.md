...
| ---------------------------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `@croco/frontend-react`      | Beta.          | Package tests cover page data/meta hooks and the meta-vite helper boundary. Generated `meta-vite-fullstack-workers` smoke proves browser hydration, page data flow, and visible hydration mismatch failure. Production-ready still requires broader app-entry/bootstrap coverage beyond one generated fullstack profile. |
