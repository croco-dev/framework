...
describe('Cloudflare adapter', () => {
  it('returns the API response when an API handler matches the request', async () => {
    ...
    const response = await handler(new Request('https://example.test/api/users'), {}, createExecutionContext());
  ...
  it('forwards Cloudflare env and execution context to RuntimeContext', async () => {
    ...
    const response = await handler(new Request('https://example.test/runtime'), env, executionContext);
  ...
  it('preserves a streaming Response body in a fetch-like runtime', async () => {
    ...
    const response = await handler(new Request('https://example.test/api/stream'), {}, createExecutionContext());
