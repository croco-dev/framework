...
export type SsgRenderFunction = (route: RenderRouteIR, props: RenderRouteComponentProps) => Promise<string> | string;
...
export async function renderRouteToString(route: RenderRouteIR, props: RenderRouteComponentProps): Promise<string> {
