...
describe("PgSearchStrategy", () => {
  ...
  registerStrategyIndexQueryTests(() => new PgSearchStrategy());
  ...
  describe("buildSearchQuery", () => {
    it("should build correct search query with BM25 operator", () => {
      ...
      expect(sqlString).toContain('SELECT *, paradedb.score("id") AS "__croco_search_score"');
      ...
      expect(totalSqlString).toContain('"users" @@@ $1');
