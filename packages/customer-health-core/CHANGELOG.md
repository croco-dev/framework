...
- 4f5434b: Return in-memory health score history newest-first and provide a shared adapter conformance suite for transition ordering and limits.
...
- 8e9e9db: Reject health score profiles whose category weights do not sum to 1 before calculating or storing a score.
...
- 9f663fe: Reject health signals with an unsupported category before calculating a tenant health score.
