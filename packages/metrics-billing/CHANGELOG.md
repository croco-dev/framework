...
- 34690e7: 기간 말로 예약된 구독 취소는 실제 취소 시점까지 churn MRR로 기록하지 않습니다.
...
- becf14f: Monthly MRR now rounds each subscription to a whole minor unit, with exact halves rounded away from zero. Snapshot totals and billing movements use the same rounded amounts, so fractional plan rates can be stored in integer metrics columns.
...
- Updated dependencies [377c684]
  ...
  - @croco/metrics-core@1.0.0

## 0.1.0

### Minor Changes

- 4d7bbb6: Analytics and billing metrics now expose flush, readiness, disabled-mode, and dropped-metric failure evidence without treating lost events as success.

### Patch Changes

- d707a0c: Published package manifests now declare the Croco framework GitHub repository metadata required for npm provenance verification.
- Updated dependencies [2ceb6c4]
- Updated dependencies [4d7bbb6]
