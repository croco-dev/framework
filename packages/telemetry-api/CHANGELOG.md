...
- 6a6a765: Generated RPC requests now propagate installed OpenTelemetry context without fabricating sampled
...
- c5a4e6d: Problem errors expose their stable code, category, and HTTP status as span attributes.
