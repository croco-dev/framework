...
- f683f07: Use localhost for missing or invalid Node HTTP Host headers and release oversized request streams after sending the 413 Problem response.
...
- 0a2cd52: Preserve every Set-Cookie header when forwarding GraphQL Yoga responses through the Node server adapter.
...
- 735db1a: Close retained HTTP connections when GraphQLServer.stop() shuts down the listener, including requests still in progress. Concurrent stop calls share shutdown completion, and HTTP close callback errors reject the shutdown promise.
- ba89b35: Reject GraphQL server startup on port binding errors and release startup listeners after binding succeeds or fails.
- Updated dependencies [4ca14ab]
- Updated dependencies [38cba9c]
- Updated dependencies [98001e1]
- Updated dependencies [7008727]
- Updated dependencies [921fd58]
