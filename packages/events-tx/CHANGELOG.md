...
- a8d6717: Escape null bytes in persisted inbox and outbox failure details so PostgreSQL can record the failure instead of leaving the message claim unfinished.
...
- e506f59: Prevent outbox messages that exhausted their publish attempts from being claimed again after their visibility lease expires.
