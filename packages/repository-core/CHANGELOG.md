...
- 248d37b: - docs(repository-core): show compilable keyed batch loading examples
...
- 6b7d531: Preserve decorated repository method behavior when batch loading methods other than `findById`.
- f22d86c: Keep request-scoped batch loaders isolated by decorated method and repository, tenant, data-source, or transaction identity while preserving explicit safe sharing.
