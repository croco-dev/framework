...
describe('AnalyticsManager', () => {
  ...
  describe('group', () => {
    ...
    it('should handle different group types', () => {
      ...
      expect(analyticsManager.group).toHaveBeenNthCalledWith(1, 'organization', 'org-123', { name: 'OpenAI' });
      expect(analyticsManager.group).toHaveBeenNthCalledWith(2, 'tenant', 'tenant-abc', { tier: 'pro' });
      expect(analyticsManager.group).toHaveBeenNthCalledWith(3, 'account', 'acct-xyz', { status: 'active' });
    });
