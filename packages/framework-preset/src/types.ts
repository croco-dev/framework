...
export type HookMap = {
  readonly 'build:before'?: (config: CrocoPresetConfig) => Promise<CrocoPresetConfig> | CrocoPresetConfig;
  readonly 'build:after'?: (result: { readonly success: boolean; readonly outputDir: string }) => Promise<void> | void;
