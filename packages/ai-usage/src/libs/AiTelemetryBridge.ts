...
export interface AiTelemetrySpanAdapter {
...
const GEN_AI_USAGE_AI_INPUT_TOKENS = "gen_ai.usage.prompt_tokens";
const GEN_AI_USAGE_AI_OUTPUT_TOKENS = "gen_ai.usage.completion_tokens";
...
export class AiTelemetryBridge {
  /**
   ...
   */
  async recordUsage(usageRecord: AiUsageRecord, span: AiTelemetrySpanAdapter): Promise<void> {
   ...
   * - GenAI Semantic Conventions 준수
   */
  mapToGenAiAttributes(usageRecord: AiUsageRecord): Record<string, unknown> {
    const attributes: Record<string, unknown> = {
      [GEN_AI_SYSTEM]: usageRecord.provider,
      [GEN_AI_REQUEST_MODEL]: usageRecord.modelId,
      [GEN_AI_USAGE_AI_INPUT_TOKENS]: usageRecord.inputTokens,
      [GEN_AI_USAGE_AI_OUTPUT_TOKENS]: usageRecord.outputTokens,
