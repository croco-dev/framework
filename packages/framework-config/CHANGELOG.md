...
- 144b80b: Infer bootstrapped configuration output from a typed Zod schema definition and retire caller-selected return generics from the deprecated decorator path.
...
- 9cb6b87: Report missing, malformed, and invalid environment settings distinctly while keeping input values out of validation diagnostics.
