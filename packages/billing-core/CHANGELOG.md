...
- c74e71d: Convert decimal money values to minor units with exact decimal-ratio arithmetic so half-up rounding is not distorted by floating-point multiplication.
