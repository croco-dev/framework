...
- cca635b: Preserve OPEN and HALF_OPEN in-memory circuit breaker states during idle and capacity eviction while continuing to reclaim CLOSED circuits.
...
- 9b269fb: Circuit breakers leave caller-caused Problems out of failure counts and allow applications to choose which errors open a circuit.
