...
- d9989ff: Reject incomplete OpenAI Responses across buffered generation, structured output, tool calls, and streaming.
- 1848050: - fix: reject malformed OpenAI function-call responses instead of reporting successful tool results
