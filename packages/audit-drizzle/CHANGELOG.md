...
- 00fe494: Round-trip audit payloads, diffs, and metadata through PostgreSQL JSONB columns without double encoding while preserving text-column serialization.
