...
- 7b1d67d: Return session pages in a stable newest-first order and report the full matching session count for partial, empty, and out-of-range pages.
...
- 9c1796d: Preserve direct and transitive inherited permissions when resolving Drizzle-backed roles.
