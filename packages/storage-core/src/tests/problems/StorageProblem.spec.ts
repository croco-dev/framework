...
describe('StorageProblem', () => {
  ...
  it('다양한 category로 생성 가능', () => {
    ...
    const problem2 = new TestStorageProblem('TEST_STORAGE', ProblemCategory.BadRequest, 'Invalid request');
  ...
  it('Problem을 상속받으므로 Problem 인스턴스로 throw/catch 가능', () => {
    ...
    expect(() => {
      throw new TestStorageProblem('TEST_STORAGE', ProblemCategory.InternalServerError, 'Test error');
