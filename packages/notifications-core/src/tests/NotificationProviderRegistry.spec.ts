...
describe('NotificationProviderRegistry', () => {
  ...
  it('should throw when a provider name is already registered', () => {
    ...
    expect(() => registry.registerProvider(createProvider('shared-provider', NotificationChannel.SMS))).toThrow(
      NotificationProviderAlreadyRegisteredProblem
    );
  });
  ...
  it('should throw when the same provider instance is registered twice', () => {
    ...
    expect(() => registry.registerProvider(provider)).toThrow(NotificationProviderAlreadyRegisteredProblem);
  });
  ...
  it('should throw when the same default provider is registered twice for a channel', () => {
    ...
    expect(() => registry.registerProvider(provider, true)).toThrow(NotificationProviderAlreadyRegisteredProblem);
  });
