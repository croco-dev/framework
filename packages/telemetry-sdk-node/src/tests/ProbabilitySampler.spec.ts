    ...
    describe('BUG-08 64비트 TraceID에서 정밀도 유지', () => {
      it('MAX_SAFE_INTEGER 초과 traceId로 일관된 샘플링 결과 반환', () => {
        ...
        const results = Array.from({ length: 10 }, () =>
          sampler.shouldSample({}, maxTraceId, 'test-span', undefined, {}, [])
        );
      ...
      it('경계값 traceId로 정확한 샘플링 비율 유지', () => {
        ...
        const result = sampler.shouldSample({}, boundaryTraceId, 'test-span', undefined, {}, []);
      ...
      it('MAX_SAFE_INTEGER 초과 traceId로 NOT_SAMPLE 결정 검증', () => {
        ...
        const result = sampler.shouldSample({}, maxTraceId, 'test-span', undefined, {}, []);
