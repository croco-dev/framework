  ...
  describe('shouldSample', () => {
    ...
    describe('BUG-08 64비트 TraceID에서 정밀도 유지', () => {
      ...
      it('경계값 traceId로 정확한 샘플링 비율 유지', () => {
        ...
        const result = sampler.shouldSample(ROOT_CONTEXT, boundaryTraceId, 'test-span', SpanKind.INTERNAL, {}, []);
      ...
      it('MAX_SAFE_INTEGER 초과 traceId로 NOT_SAMPLE 결정 검증', () => {
        ...
        const result = sampler.shouldSample(ROOT_CONTEXT, maxTraceId, 'test-span', SpanKind.INTERNAL, {}, []);
