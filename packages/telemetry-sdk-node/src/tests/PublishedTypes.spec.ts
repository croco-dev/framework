    ...
    () => {
      ...
      try {
        ...
        writeFileSync(
          ...
          [
            'import { TelemetryDiagnosticsProvider } from "@croco/telemetry-sdk-node";',
            'import type { AutoInstrumentationConfig, TelemetryDiagnosticsDetails, TelemetryDiagnosticsHealthStatus, TelemetryDiagnosticsMode, TelemetryDiagnosticsProviderOptions, TelemetryDiagnosticsRequirement, TraceConfig } from "@croco/telemetry-sdk-node";',
            ...
            "};",
            "",
            'const diagnosticsOptions = { requirement: "required" } satisfies TelemetryDiagnosticsProviderOptions;',
            "const diagnostics = new TelemetryDiagnosticsProvider(diagnosticsOptions);",
            'const diagnosticsRequirement: TelemetryDiagnosticsRequirement = "required";',
            'const diagnosticsMode: TelemetryDiagnosticsMode = "startup_failed";',
            "const readFailureCode = (health: TelemetryDiagnosticsHealthStatus): string | undefined =>",
            '  health.details.mode === "startup_failed" ? health.details.failureCode : undefined;',
            "const readMode = (details: TelemetryDiagnosticsDetails): TelemetryDiagnosticsMode => details.mode;",
            "",
            "void traceConfig;",
            "void diagnostics;",
            "void diagnosticsRequirement;",
            "void diagnosticsMode;",
            "void readFailureCode;",
            "void readMode;",
            "",
          ].join("\n"),
        );
