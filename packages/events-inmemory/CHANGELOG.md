...
- 1b39af2: Reject publishes that omit subscribers under the drop strategy with a typed, count-bearing Problem.
...
- aefe86a: Keep active event handlers visible to concurrency limits and graceful shutdown until their promises settle, even when subscriptions are removed or cleared.
