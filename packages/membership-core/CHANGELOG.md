...
- 4237d35: Defer ownership transfer events until an ambient transaction commits, while continuing to publish immediately when
...
- 17f67c8: Keep in-memory tenant and user membership identities distinct when either identifier contains delimiters.
